package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public static const const_623:int = 8;
      
      public static const const_1556:int = 10;
      
      public static const const_1238:int = 6;
      
      private static var var_965:Boolean = describeType(ByteArray).factory.method.(@name == "uncompress").hasComplexContent();
      ...
      public static const const_1554:int = 4;
      
      public static const const_1432:int = 5;
      
      public static const const_1557:int = 9;
      
      public static const const_1442:int = 7;
       
      
      private var var_155:uint = 0;
      
      private var var_964:uint = 0;
      ...
      private var var_1422:String = "2.0";
      ...
      private function parseFileContent(param1:IDataInput) : Boolean
      {
         ...
         {
            if(param1.bytesAvailable < var_155)
            {
               return false;
            }
            parseContent(param1);
      ...
      protected function parseContent(param1:IDataInput) : void
      {
         ...
         if(var_643 === const_623 && !var_1423)
         {
            ...
            else
            {
               ...
               _loc2_ = uint(~var_1829 << 6 & 192);
               _loc2_ += 31 - (30720 | _loc2_) % 31;
               var_17.writeByte(_loc2_);
               param1.readBytes(var_17,2,var_155);
               var_17.position = var_17.length;
               var_17.writeUnsignedInt(var_772);
            }
            var_154 = true;
         }
         else
         {
            if(var_643 != const_1126)
            {
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         param1.writeShort(var_1155 << 8 | 20);
         param1.writeShort(var_317 == "utf-8" ? 2048 : 0);
         param1.writeShort(const_623);
         ...
         param1.writeUnsignedInt(var_155);
         param1.writeUnsignedInt(var_535);
         var _loc8_:ByteArray = new ByteArray();
         _loc8_.endian = Endian.LITTLE_ENDIAN;
         if(var_317 == "utf-8")
         {
            _loc8_.writeUTFBytes(var_377);
         }
         else
         {
            _loc8_.writeMultiByte(var_377,var_317);
         }
         ...
         if(param2)
         {
            if(!var_442)
            {
               ...
               var_772 = ChecksumUtil.Adler32(var_17,0,var_17.length);
               var_442 = true;
               if(_loc16_)
               {
                  compress();
            ...
            _loc8_.writeShort(4);
            _loc8_.writeUnsignedInt(var_772);
         }
         ...
         if(param3 && false)
         {
            if(var_317 == "utf-8")
            {
               _loc8_.writeUTFBytes(var_1830);
            }
            else
            {
               _loc8_.writeMultiByte(var_1830,var_317);
            }
         }
      ...
      protected function compress() : void
      {
         if(!var_154)
         {
            ...
            {
               var_17.position = 0;
               var_535 = var_17.length;
               if(var_965)
               {
                  var_17.compress.apply(var_17,["deflate"]);
                  var_155 = var_17.length;
               }
               else
               {
                  var_17.compress();
      ...
      {
         if(param1.bytesAvailable >= var_964 + var_1154)
         {
            parseHeadExt(param1);
            parseFunc = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_317 == "utf-8")
         {
            var_377 = param1.readUTFBytes(var_964);
         }
         else
         {
            var_377 = param1.readMultiByte(var_964,var_317);
         }
         var _loc2_:uint = var_1154;
         while(_loc2_ > 4)
         {
            ...
            if(_loc4_ > _loc2_)
            {
               throw new Error("Parse error in file " + var_377 + ": Extra field data size too big.");
            }
            if(_loc3_ === 56026 && _loc4_ === 4)
            {
               var_772 = param1.readUnsignedInt();
               var_442 = true;
            }
            else if(_loc4_ > 0)
            {
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1155 = _loc2_ >> 8;
         var_1422 = Math.floor((_loc2_ & 255) / 10) + "." + (_loc2_ & 255) % 10;
         var _loc3_:uint = param1.readUnsignedShort();
         var_643 = param1.readUnsignedShort();
         var_1423 = (_loc3_ & 1) !== 0;
         var_1421 = (_loc3_ & 8) !== 0;
         var_1828 = (_loc3_ & 32) !== 0;
         if((_loc3_ & 800) !== 0)
         {
            var_317 = "utf-8";
         }
         if(var_643 === const_1238)
         {
            var_2276 = (_loc3_ & 2) !== 0 ? 8192 : 4096;
            var_2275 = (_loc3_ & 4) !== 0 ? 3 : 2;
         }
         else if(var_643 === const_623)
         {
            var_1829 = (_loc3_ & 6) >> 1;
         }
         ...
         var_155 = param1.readUnsignedInt();
         var_535 = param1.readUnsignedInt();
         var_964 = param1.readUnsignedShort();
         var_1154 = param1.readUnsignedShort();
      }
      ...
      {
         return "[FZipFile]\n  name:" + var_377 + "\n  date:" + var_645 + "\n  sizeCompressed:" + var_155 + "\n  sizeUncompressed:" + var_535 + "\n  versionHost:" + var_1155 + "\n  versionNumber:" + var_1422 + "\n  compressionMethod:" + var_643 + "\n  encrypted:" + var_1423 + "\n  hasDataDescriptor:" + var_1421 + "\n  hasCompressedPatchedData:" + var_1828 + "\n  filenameEncoding:" + var_317 + "\n  crc32:" + var_644.toString(16) + "\n  adler32:" + var_772.toString(16);
      }
