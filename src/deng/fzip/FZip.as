package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_431 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         return !true ? var_116[param1] as FZipFile : null;
      }
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_626))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_626,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_84 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_626,"EOF"));
            }
         }
      }
      ...
      {
         if(var_431.parse(param1))
         {
            var_39.push(var_431);
            if(false)
            {
               var_116["null"] = var_431;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1156,var_431));
            var_431 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_39 != null && var_116 != null && param1 < var_39.length)
         {
            _loc2_ = var_39[param1] as FZipFile;
            if(_loc2_ != null)
            {
               var_39.splice(param1,1);
               delete var_116[_loc2_.filename];
               return _loc2_;
            }
         }
         return null;
