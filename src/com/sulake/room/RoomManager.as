package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_418:IRoomObjectFactory = null;
      
      private var var_1458:int;
      
      private var var_2330:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_419 = [];
         var_420 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_318,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_370,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_520,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(var_30 == const_1229)
         {
            if(var_721 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = var_418.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_418 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_420.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
         var_420.splice(_loc2_,1);
         var _loc3_:int = -1;
         while(_loc3_ >= 0)
         {
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_418 != null)
         {
            return var_418.createRoomObjectManager();
         }
         return null;
      }
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_418.createRoomObjectLogic(_loc18_);
