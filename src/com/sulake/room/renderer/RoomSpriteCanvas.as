package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_42:Sprite;
      
      private var var_1366:int = 0;
      
      private var var_427:Array;
      
      private var var_272:Map = null;
      ...
      private var var_204:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1662:Number = -10000000;
      
      private var var_1661:Number = -10000000;
      ...
      private var var_907:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_42 = new Sprite();
         var_42.name = "canvas";
         var_42.mouseEnabled = false;
         _master.addChild(var_42);
         var_42.mouseEnabled = true;
         var_42.doubleClickEnabled = true;
         var_42.addEventListener(MouseEvent.CLICK,clickHandler);
         var_42.addEventListener(MouseEvent.DOUBLE_CLICK,clickHandler);
         _geometry = new RoomGeometry(param5,new Vector3d(-135,30,0),new Vector3d(11,11,5),new Vector3d(-135,0.5,0));
         var_204 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
      ...
      public function update() : void
      {
         if(var_909 == 0)
         {
            checkMouseHits(var_910.x,var_910.y,MouseEvent.MOUSE_MOVE);
         }
         var_909 = 0;
         ++var_1366;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_906 = param1;
         var_908 = param2;
         var_42.graphics.clear();
         var_42.graphics.beginFill(var_2314);
         var_42.graphics.drawRect(0,0,param1,param2);
         var_42.mask = var_233;
      }
      ...
      {
         var _loc11_:Number = param1 - var_906 / 2;
         var _loc12_:Number = param2 - var_908 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         var_608.push(_loc12_ - _loc2_);
         if(var_608.length == const_727)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_727)
            {
               _loc13_ += var_608[_loc14_];
               _loc14_++;
            }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_272 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_272.getKey(_loc1_);
            _loc3_ = var_272.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_907 != null)
                  {
                     var_907.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1366,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_42.numChildren)
         {
            return null;
         }
         return var_42.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc6_ = var_204.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_204.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         while(_loc5_ >= param1)
         {
            _loc3_ = var_42.getChildAt(_loc5_);
            _loc6_ = null;
      ...
      {
         if(var_272 != null && param1 != null)
         {
            var_272.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            _loc10_ = var_42.getChildAt(_loc14_) as ExtendedSprite;
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_426.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_426.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1662 || param2 != var_1661)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_426.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_426.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= var_42.numChildren)
         {
            var_42.addChild(_loc3_);
         }
         else
         {
            var_42.addChildAt(_loc3_,param2);
         }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_204.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_204.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(param1 >= var_42.numChildren)
         {
            createSprite(param2);
            return true;
         }
         var _loc3_:IRoomObjectSprite = param2.sprite;
         var _loc4_:ExtendedSprite = var_42.getChildAt(param1) as ExtendedSprite;
         if(_loc4_ != null)
         {
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:int) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_204.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     var_204.addBitmapData(_loc6_,_loc5_);
                  }
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:int) : int
      {
         ...
         _loc8_ += int(var_906 / 2);
         _loc9_ += int(var_908 / 2);
         ...
         while(_loc18_ < _loc7_)
         {
            ...
            if(_loc13_ != null && _loc13_.visible)
            {
               ...
               if(_loc19_ != null)
               {
                  ...
                  if(_loc14_ + _loc19_.width >= 0 && _loc14_ < var_906 && (_loc15_ + _loc19_.height >= 0 && _loc15_ < var_908))
                  {
                     if(_loc11_ < _loc17_)
                     {
