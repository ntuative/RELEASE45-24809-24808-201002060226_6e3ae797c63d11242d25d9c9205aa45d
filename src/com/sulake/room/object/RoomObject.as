package com.sulake.room.object
{
   ...
   public class RoomObject implements IRoomObjectController
   {
      ...
      public function setLocation(param1:IVector3d) : void
      {
         ...
         if(var_65.x != param1.x || var_65.y != param1.y || var_65.z != param1.z)
         {
            var_65.x = param1.x;
            var_65.y = param1.y;
            var_65.z = param1.z;
      ...
      {
         var_1461.assign(var_224);
         return var_1461;
      }
      
      public function setState(param1:int, param2:int) : Boolean
      {
         if(param2 >= 0 && param2 < var_453.length)
         {
            if(var_453[param2] != param1)
            {
               var_453[param2] = param1;
               ++_updateID;
            }
            return true;
         }
      ...
      {
         if(param1 >= 0 && param1 < var_453.length)
         {
