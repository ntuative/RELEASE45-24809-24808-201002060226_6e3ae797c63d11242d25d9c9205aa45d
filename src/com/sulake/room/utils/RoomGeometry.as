package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_585:Number = 64;
      
      public static const const_922:Number = 32;
      ...
      private var var_2321:Number = 500;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            _y.assign(_loc24_);
            var_78.assign(_loc25_);
         }
         else
         {
            var_79.assign(_loc18_);
            _y.assign(_loc19_);
            var_78.assign(_loc20_);
         }
      }
      
      public function set z_scale(param1:Number) : void
      {
         if(var_404 != param1 * var_1497)
         {
            var_404 = param1 * var_1497;
            ++var_71;
         }
      }
      ...
      {
         if(var_403 != param1 * var_1495)
         {
            var_403 = param1 * var_1495;
            ++var_71;
         }
      }
      ...
      {
         if(var_401 != param1 * var_1496)
         {
            var_401 = param1 * var_1496;
            ++var_71;
         }
      }
      ...
      {
         var _loc2_:Vector3d = Vector3d.dif(param1,var_65);
         _loc2_.x *= var_403;
         _loc2_.y *= var_401;
         _loc2_.z *= var_404;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1013);
         if(_loc3_ < var_2320 || _loc3_ > var_2321)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            _loc2_ = Vector3d.dif(param1,var_65);
            _loc2_.add(_loc6_);
            _loc2_.x *= var_403;
            _loc2_.y *= var_401;
            _loc2_.z *= var_404;
      ...
      {
         return new Vector3d(0 * var_403,0 * var_401,0 * var_404);
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc4_:Number = Vector3d.scalarProjection(param1,var_78);
         return new Vector3d(_loc2_,_loc3_,_loc4_);
      }
      
      public function get directionAxis() : IVector3d
      {
         return new Vector3d(var_78.x,var_78.y,var_78.z);
      }
      
      public function isZoomedIn() : Boolean
      {
         return scale == const_585;
      }
      ...
      {
         if(param1 == null || var_78 == null)
         {
            return;
         }
         var _loc3_:Vector3d = Vector3d.product(var_78,param2);
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         var_65.y = 0 / var_401;
         var_65.z = 0 / var_404;
         if(var_65.x != _loc2_ || var_65.y != _loc3_ || var_65.z != _loc4_)
         {
            ++var_71;
         }
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_403,0 * var_401,0 * var_404);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_78;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_403,param2.y * var_401,param2.z * var_404);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_403,param3.y * var_401,param3.z * var_404);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_403,param4.y * var_401,param4.z * var_404);
