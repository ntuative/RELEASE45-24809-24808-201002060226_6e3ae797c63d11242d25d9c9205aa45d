package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_461:IKeyExchange;
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2005)
         {
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1238,var_2006));
         var _loc2_:String = "";
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_461.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_461.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2007);
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1238 = _habboConfiguration.getKey("flash.client.url","");
         var_2006 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_163 == null)
         {
         ...
         if(var_669 != null)
         {
            var_62.mode = HabboConnectionType.const_334;
            var_62.initConnection(HabboConnectionType.const_218);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1479 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_699);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2007 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_62.mode)
         {
            case HabboConnectionType.const_334:
               _loc6_ = "";
               ...
               var_1005 = _loc4_;
               var_163.loadBannerImage(_loc7_ + "?token=" + var_1005,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1323:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1321:
               var_1006 = generateRandomHexString(30);
               var_461 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_461.init(var_1006);
               _loc8_ = var_461.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1005);
         ...
         var_461 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_1006 = generateRandomHexString(30);
            var_461.init(var_1006);
            _loc12_ = var_461.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_139,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_79,onRoomSessionEnded);
      }
