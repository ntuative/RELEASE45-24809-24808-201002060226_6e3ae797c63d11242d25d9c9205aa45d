package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_633:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_334.shockwaveClientUrl = var_109.shockwaveClientUrl;
         var_334.ssoTicket = var_109.ticket;
         var_109.removeEventListener(SSOTicket.const_296,onParsedTicketSuccess);
         var_109.removeEventListener(SSOTicket.const_252,onParsedTicketFailure);
         var_109 = null;
         dispatchEvent(new Event(const_633));
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = var_334.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_353,HabboWindowStyle.const_23,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_109 = new SSOTicket(var_334.assets,_loc2_,_loc1_);
         var_109.addEventListener(SSOTicket.const_296,onParsedTicketSuccess);
         var_109.addEventListener(SSOTicket.const_252,onParsedTicketFailure);
      }
