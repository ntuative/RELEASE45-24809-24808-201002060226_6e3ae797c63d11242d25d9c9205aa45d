package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2244:BitmapData;
      ...
      private const const_1408:Number = 1;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1388));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1324);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               _window.blend = const_1408;
               _loc1_.blend = const_1408;
            }
         }
         if(isSelected)
         {
         ...
         if(_loc5_)
         {
            if(var_1328 && getRecyclableCount() > 0)
            {
               _loc5_.bitmap = var_2244;
               _loc5_.visible = true;
            }
            else
            {
