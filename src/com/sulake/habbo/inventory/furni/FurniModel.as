package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_446 = new Timer(const_1058,1);
         var_446.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_213;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_380.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_380.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_446 != null)
            {
               var_446.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_446.stop();
               var_446 = null;
            }
            if(var_126 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         else if(param3 == FurniCategory.const_274)
         {
         ...
         else if(param3 == FurniCategory.const_270)
         {
         ...
         if(var_652 == null)
         {
            var_652 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = var_652.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_213:
               ...
               break;
            case InventorySubCategory.const_802:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_409);
      ...
      {
         if(param1 == InventoryCategory.const_52 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_25:
                  ...
                  break;
               case const_264:
                  _controller.toggleInventoryPage(InventoryCategory.const_137);
            }
         }
      }
      ...
      {
         if(var_780 && param1.type == RoomEngineObjectEvent.const_188)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_274 || _loc3_.category == FurniCategory.const_316 || _loc3_.category == FurniCategory.const_270)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_380 = new Map();
         var_380.add(const_24,new Array());
         var_380.add(const_25,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
