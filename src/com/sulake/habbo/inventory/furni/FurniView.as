package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_609:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_498 = new Map();
         var_498.add(FurniModel.const_24,new FurniGridView(_model,FurniModel.const_24,_windowManager,_assetLibrary,_roomEngine));
         var_498.add(FurniModel.const_25,new FurniGridView(_model,FurniModel.const_25,_windowManager,_assetLibrary,_roomEngine));
         ...
         else if(param1.type == WindowEvent.const_35)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_264);
            }
         }
      }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:FurniGridView = var_498.getValue(var_497);
         if(_loc4_ != null)
         {
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = _model.getGroupItemInIndex(_loc3_,var_497);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            else if(_loc5_.category == FurniCategory.const_274)
            {
            ...
            else if(_loc5_.category == FurniCategory.const_270)
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_609 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
