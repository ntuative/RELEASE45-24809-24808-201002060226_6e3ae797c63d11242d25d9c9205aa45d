package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(_view != null)
         {
            var_466 = _view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function initFromList() : void
      {
         ...
         while(_loc2_ < _loc1_.length)
         {
            ...
            var_466.addGridItem(_loc3_.window);
            _loc2_++;
         }
      }
      ...
      {
         var_466.addGridItemAt(param1,param2);
      ...
      {
         return var_466.removeGridItemAt(param1);
      }
      
      public function addItemToBottom(param1:IWindowContainer) : void
      {
         var_466.addGridItem(param1);
         param1.procedure = itemEventProc;
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_34)
         {
            ...
            _model.toggleItemSelection(_category,var_466.getGridItemIndex(param1.window));
            var_332 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_11 && var_332 != null && var_332 == param2 && true)
         {
