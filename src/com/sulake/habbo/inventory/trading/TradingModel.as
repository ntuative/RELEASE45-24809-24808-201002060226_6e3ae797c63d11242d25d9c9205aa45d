package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_279:uint = 2;
      
      public static const const_413:uint = 4;
      ...
      public static const const_1143:uint = 9;
      
      public static const const_180:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_465 = false;
         var_678 = false;
         var_40.updateItemList(var_679);
         var_40.updateItemList(var_1254);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_40.alertPopup(TradingView.const_942);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_679)
            {
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_679)
            {
               var_40.alertPopup(TradingView.const_986);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + var_30 + " NEW STATE: " + param1 + " OWN: " + var_465 + " OTHER: " + var_678);
         ...
         {
            case const_157:
               if(param1 == const_152 || param1 == const_180)
               {
                  var_30 = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_40.setMinimized(param1 != InventoryCategory.const_52);
         var_8.updateSubView();
      }
      ...
      public function close() : void
      {
         if(var_552)
         {
            if(var_30 != const_157 && var_30 != const_180)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_157;
            var_8.toggleInventorySubPage(InventorySubCategory.const_802);
            var_552 = false;
         }
         var_40.setMinimized(false);
      }
