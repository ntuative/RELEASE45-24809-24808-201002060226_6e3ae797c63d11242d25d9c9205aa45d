package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_913:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_514 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_514.width;
         var_83 = var_514.height;
         var_914 = param5;
         var_743 = param6;
         var_205 = Math.floor(var_914 / _thumbWidth);
         var_15 = new BitmapData(var_914,var_743);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_205 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_205 - param1.x - 1;
         _loc2_ = new Rectangle((param1.x + 1) * _thumbWidth,param1.y * var_83,_loc4_ * _thumbWidth,var_83);
         _loc3_ = new Point(param1.x * _thumbWidth,param1.y * var_83);
         ...
         if(param1.y < var_429 - 1)
         {
            ...
            _loc8_ = 0 - (param1.y + 1) * var_83;
            _loc9_ = new BitmapData(_loc7_,_loc8_);
            _loc2_ = new Rectangle(_thumbWidth,(param1.y + 1) * var_83,_loc9_.width,_loc9_.height);
            ...
            var_15.fillRect(new Rectangle(0,0 - var_83,var_15.width,var_83),4294967295);
            _loc3_ = new Point(0 - _thumbWidth,_loc2_.y - var_83);
         ...
         if(_loc6_ > 0)
         {
            ...
            if(param1.x == var_205 - 1)
            {
               _loc11_ = new BitmapData(var_15.width,0 - var_83);
               _loc2_ = new Rectangle(0,0,var_15.width,0 - var_83);
               _loc11_.copyPixels(var_15,_loc2_,new Point(0,0),null,null,true);
               var_15 = _loc11_;
               --var_429;
            }
         }
         if(var_15.height < var_743)
         {
            _loc12_ = new BitmapData(var_15.width,var_743);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_514.width,var_514.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_514.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_514,var_514.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_913 != null)
         {
            _loc1_ = var_913.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_15 = new BitmapData(Math.max(var_205 * _thumbWidth,var_914),Math.max(var_429 * var_83,var_743),true,16777215);
            ...
            while(_loc4_ < var_205)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_15.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_83),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_205 && var_15.height < _loc3_.y * var_83)
         {
            _loc2_ = new BitmapData(var_15.width,var_15.height + var_83);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_205 - 1),var_83);
         _loc2_.copyPixels(var_15,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_205 - 1),0,_thumbWidth,var_15.height);
         _loc2_.copyPixels(var_15,_loc4_,new Point(0,var_83),null,null,true);
         _loc4_ = new Rectangle(0,var_83,_thumbWidth * (var_205 - 1),0 - var_83);
         _loc2_.copyPixels(var_15,_loc4_,new Point(_thumbWidth,var_83),null,null,true);
         var_15 = _loc2_;
      }
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_205));
      }
      
      private function resolveGridLocationFromImage(param1:Point) : Point
      {
         var _loc2_:int = Math.floor(param1.y / var_83);
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_205);
         var _loc3_:int = param1 % var_205;
         return new Point(_loc3_,_loc2_);
      }
      ...
      public function replaceItemImage(param1:int, param2:IThumbListDrawableItem) : void
      {
         ...
         var _loc4_:Point = new Point(_loc3_.x * _thumbWidth,_loc3_.y * var_83);
