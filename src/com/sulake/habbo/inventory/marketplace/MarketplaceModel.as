package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_203 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_203.ref));
         releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = var_203 is FloorItem ? 1 : 2;
         var_1628 = _loc2_;
         var_1627 = var_203.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,var_203.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1359,var_1360);
         }
      }
      ...
      {
         if(param1 != var_1628 || param2 != var_1627)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1632);
      }
      ...
      {
         if(_controller != null && false && var_203 != null)
         {
            _controller.furniModel.removeLockFrom(var_203.id);
            var_203 = null;
         }
      }
