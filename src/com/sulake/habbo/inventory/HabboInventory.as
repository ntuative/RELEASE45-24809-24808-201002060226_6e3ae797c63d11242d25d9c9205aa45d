package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_38.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_38.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_18 != null)
         {
            ...
            var_18.events.removeEventListener(RoomSessionEvent.const_79,roomSessionEventHandler);
            var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_440,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_38.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_79:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_440:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_38.getValue(InventoryCategory.const_549));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_38.getValue(InventoryCategory.const_52));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_801));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_38.getValue(InventoryCategory.const_137));
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_38.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:IInventoryModel = var_38.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
      ...
      {
         return AchievementsModel(var_38.getValue(InventoryCategory.const_292));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_744.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_744.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = var_38.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_38.length)
         {
            _loc3_ = var_38.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_213:
               _view.toggleCategoryView(InventoryCategory.const_52,false);
         }
      }
      ...
      {
         return TradingModel(var_38.getValue(InventorySubCategory.const_213));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_513 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_744.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_38.getValue(InventoryCategory.const_409) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1373 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_38.getValue(InventoryCategory.const_215));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_18.events.addEventListener(RoomSessionEvent.const_79,roomSessionEventHandler);
         var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_440,roomSessionEventHandler);
         ...
         var_38.add(InventoryCategory.const_409,_loc3_);
         ...
         var_38.add(InventoryCategory.const_52,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_513);
         var_38.add(InventoryCategory.const_215,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_38.add(InventoryCategory.const_549,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_513);
         var_38.add(InventoryCategory.const_292,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_38.add(InventorySubCategory.const_213,_loc8_);
         var _loc9_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_38.add(InventorySubCategory.RECYCLER,_loc9_);
         ...
         var_38.add(InventoryCategory.const_137,_loc10_);
