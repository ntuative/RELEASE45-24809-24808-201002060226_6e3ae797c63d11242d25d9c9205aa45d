package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_860:String = "issue_bundle_open";
      
      public static const const_693:String = "issue_bundle_my";
      
      public static const const_775:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_121 = new Map();
         var_765 = new Map();
         var_529 = new IssueBrowser(this,var_48.windowManager,var_48.assets);
         var_629 = [];
         var_764 = [];
         var_949 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_949.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_629 = var_629.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_765.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_765.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1358)
         {
            var_142.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_121)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_765.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_765.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_117)
         {
            ...
            _loc8_ = var_764.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      {
         var _loc2_:* = var_949.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_48.soundManager.playSound(HabboSoundTypesEnum.const_988);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_765.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_121.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
