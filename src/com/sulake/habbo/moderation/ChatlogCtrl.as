package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1365:IMessageComposer;
      ...
      {
         var_829 = IWindowContainer(var_41.getXmlWindow("chatlog_roomheader"));
         var_828 = IWindowContainer(var_41.getXmlWindow("chatlog_chatline"));
         var_462 = new Timer(300,1);
         var_462.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_45 = IFrameWindow(var_41.getXmlWindow("chatlog_frame"));
         var_43 = IItemListWindow(var_45.findChildByName("chatline_list"));
         var_45.procedure = onWindow;
         var _loc1_:IWindow = var_45.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_41.connection.send(var_1365);
         var_41.messageHandler.addChatlogListener(this);
      }
      ...
      public function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         ...
         var_41.messageHandler.removeChatlogListener(this);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_829.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_45,var_41,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_828.clone());
         _loc4_.color = var_1244[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         var _loc5_:ITextWindow = ITextWindow(_loc4_.findChildByName("time_txt"));
         _loc5_.text = RoomVisitsCtrl.method_3(param2.hour,param2.minute);
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_45,var_41,_loc6_,param2.chatterId);
         }
