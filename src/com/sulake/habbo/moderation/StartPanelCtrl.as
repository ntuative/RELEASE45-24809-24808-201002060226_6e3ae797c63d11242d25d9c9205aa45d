package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl
   {
      ...
      private function onUserinfoButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new UserInfoFrameCtrl(var_41,_userId),var_45,false,false,true);
      }
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new RoomToolCtrl(var_41,_roomId),var_45,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1290 ? 0 : 1,_roomId),var_41,WindowTracker.const_629,_roomId),var_45,false,false,true);
      }
      ...
      {
         if(var_41.initMsg.chatlogsPermission)
         {
      ...
      public function show() : void
      {
         if(var_45 == null)
         {
            var_45 = IFrameWindow(var_41.getXmlWindow("start_panel"));
            ...
            var_41.disableButton(var_41.initMsg.cfhPermission,var_45,"ticket_queue_but");
