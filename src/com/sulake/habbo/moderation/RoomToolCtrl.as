package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_734:IDropMenuWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_41,WindowTracker.const_629,_data.flatId),var_45,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_387);
         if(param1.flatId != var_387)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_387);
            return;
         }
         _data = param1;
         populate();
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new UserInfoFrameCtrl(var_41,_data.ownerId),var_45,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var_41.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1228,_loc2_,var_362.text,"",""));
         if(false)
         {
            var_41.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_905.isSelected,var_904.isSelected,var_605.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1349);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1355);
      }
      
      public function populate() : void
      {
         var_43 = IItemListWindow(var_45.findChildByName("list_cont"));
         ...
         var_734 = IDropMenuWindow(var_45.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_734);
         var_734.procedure = onSelectTemplate;
         var_605 = ICheckBoxWindow(var_45.findChildByName("kick_check"));
         var_905 = ICheckBoxWindow(var_45.findChildByName("lock_check"));
         var_904 = ICheckBoxWindow(var_45.findChildByName("changename_check"));
         ...
         var_41.disableButton(var_41.initMsg.bobbaFilterPermission,var_45,"bobba_filter_but");
         var_41.disableButton(var_41.initMsg.chatlogsPermission,var_45,"chatlog_but");
      ...
      {
         var_45 = IFrameWindow(var_41.getXmlWindow("roomtool_frame"));
         var_41.messageHandler.addRoomInfoListener(this);
         var_41.connection.send(new GetModeratorRoomInfoMessageComposer(var_387));
         Logger.log("BEGINNING TO SHOW: " + var_387);
      }
   }
}
