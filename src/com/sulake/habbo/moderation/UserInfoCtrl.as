package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_726:int = 31536000;
      
      private static const const_725:int = 86400;
      
      private static const const_724:int = 3600;
      
      private static const const_723:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_723) + " mins ago";
         }
         if(param1 < 2 * const_725)
         {
            return Math.round(param1 / const_724) + " hours ago";
         }
         if(param1 < 2 * const_726)
         {
            return Math.round(param1 / const_725) + " days ago";
         }
         return Math.round(param1 / const_726) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_41,WindowTracker.const_981,_data.userId),_callerFrame,var_903,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_732.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_41.getXmlWindow("user_info"));
            var_732.addChild(_loc1_);
            var_41.disableButton(var_41.initMsg.chatlogsPermission,_loc1_,"chatlog_but");
            var_41.disableButton(var_41.initMsg.alertPermission,_loc1_,"message_but");
            var_41.disableButton(var_41.initMsg.alertPermission || var_41.initMsg.kickPermission || var_41.initMsg.banPermission,_loc1_,"modaction_but");
         }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new ModActionCtrl(var_41,_data.userId,_data.userName,var_1119),_callerFrame,var_903,false,true);
      }
      ...
      private function onHabboInfoToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.openHkPage("habboinfotool.url",_data.userName);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new RoomVisitsCtrl(var_41,_data.userId),_callerFrame,var_903,false,true);
      }
      ...
      {
         var_41.openHkPage("moderatoractionlog.url",_data.userName);
      }
      ...
      public function load(param1:IWindowContainer, param2:int) : void
      {
         ...
         _data = null;
         refresh();
         var_41.messageHandler.addUserInfoListener(this);
         var_41.connection.send(new GetModeratorUserInfoMessageComposer(param2));
      }
      ...
      public function dispose() : void
      {
         ...
         _disposed = true;
         var_41.messageHandler.removeUserInfoListener(this);
         _callerFrame = null;
         var_41 = null;
         _data = null;
         var_732 = null;
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_41.windowTracker.show(new SendMsgsCtrl(var_41,_data.userId,_data.userName,var_1119),_callerFrame,var_903,false,true);
      }
