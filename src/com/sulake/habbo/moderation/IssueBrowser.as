package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1426:IIssueBrowserView;
      ...
      private const const_1626:String = "closed_issues";
      ...
      private var var_1425:PickedIssuesView;
      
      private var var_318:IIssueBrowserView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_318.view.width = var_215.container.width;
         var_318.view.height = var_215.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1611:
               if(var_1424 == null)
               {
                  var_1424 = new MyIssuesView(issueManager,this,var_215.container);
               }
               return var_1424;
            case const_1610:
               if(var_1426 == null)
               {
                  var_1426 = new OpenIssuesView(issueManager,this,var_215.container);
               }
               return var_1426;
            case const_1612:
               if(var_1425 == null)
               {
                  var_1425 = new PickedIssuesView(issueManager,this,var_215.container);
               }
               return var_1425;
            default:
               return null;
