package com.sulake.habbo.moderation
{
   ...
   public class OpenRoomTool
   {
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(var_1473)
         {
            var_41.windowManager.alert("Alert","Room tool is not available for public spaces. Public spaces can be moderated using in-room chat moderation commands.",0,onAlertClose);
         }
         else
         {
