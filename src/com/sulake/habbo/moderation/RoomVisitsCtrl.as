package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public static function method_3(param1:int, param2:int) : String
      {
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         onResizeTimer(null);
         var_45.visible = true;
         var_41.messageHandler.removeRoomVisitsListener(this);
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1974.clone());
         ...
         new OpenRoomTool(var_45,var_41,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         var _loc6_:ITextWindow = ITextWindow(_loc3_.findChildByName("time_txt"));
         _loc6_.text = method_3(param1.enterHour,param1.enterMinute);
         var _loc7_:ITextWindow = ITextWindow(_loc3_.findChildByName("view_room_txt"));
         new OpenRoomInSpectatorMode(var_41,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      {
         var_1974 = IWindowContainer(var_41.getXmlWindow("roomvisits_row"));
         var_462 = new Timer(300,1);
         var_462.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_41.messageHandler.addRoomVisitsListener(this);
         var_41.connection.send(new GetRoomVisitsMessageComposer(_userId));
         var_45 = IFrameWindow(var_41.getXmlWindow("roomvisits_frame"));
         var_43 = IItemListWindow(var_45.findChildByName("visits_list"));
