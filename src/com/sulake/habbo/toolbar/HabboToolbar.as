package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_578.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function method_6(param1:HabboToolbarSetIconEvent) : void
      {
         if(_view != null && var_30)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_809,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_149,method_6);
         events.addEventListener(HabboToolbarSetIconEvent.const_145,onSetToolbarIconStateEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_654,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_883,onHideWindowEvent);
         var_30 = true;
