package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_383:ToolbarBarMenuAnimator;
      ...
      {
         return var_1198.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1199.length)
         {
            _loc2_ = var_659.indexOf(var_1199[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_282[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_718 + _loc3_);
                  _loc3_ += var_1197;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_383);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_282[var_659.indexOf(param1)];
      }
