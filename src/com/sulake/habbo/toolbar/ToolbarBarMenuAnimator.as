package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private function method_1(param1:IWindowContainer, param2:String) : void
      {
         if(param1.name == "")
         {
            return;
         ...
         if(_loc3_ > -1)
         {
            ...
            var_444.splice(_loc3_,1);
         }
         var_444.push(param1.name);
         var_443.push(param2);
         param1.addEventListener(WindowEvent.const_450,windowEventListener);
         param1.addEventListener(WindowEvent.const_201,windowEventListener);
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return var_443[var_444.indexOf(param1)];
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_281.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_281.splice(var_281.indexOf(param1),1);
            }
         }
      }
      ...
      {
         return var_444[var_443.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_281[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_740 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_740 || param1.desktop.height - param1.y < const_1050;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_444.length)
         {
            if(var_444[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
