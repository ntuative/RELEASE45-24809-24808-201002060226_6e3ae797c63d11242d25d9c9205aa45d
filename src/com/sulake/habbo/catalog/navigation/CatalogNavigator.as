package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2325:String = "magic.pixels";
      
      private var var_2324:String = "catalog.page.club";
      
      private var var_2359:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_74.configuration.getKey("client.credits.embed.enabled","ItemDataUpdateMessageEvent") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var_74.openCatalogPage(var_2324,true);
      }
