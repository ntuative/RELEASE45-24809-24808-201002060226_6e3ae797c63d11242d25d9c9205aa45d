package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1099:Number = 4285716709;
      ...
      private var var_1536:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1536 == 4294967295)
            {
               var_1536 = _loc1_.color;
            }
            _loc1_.color = const_1099;
         }
      }
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_13,onIconImageReady);
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1535) as IWindowContainer;
         }
         else
         {
      ...
      {
         var_43 = navigator.catalog.windowManager.buildFromXML(var_1537) as IItemListWindow;
         if(var_43 == null)
         {
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1306;
            }
         }
      }
