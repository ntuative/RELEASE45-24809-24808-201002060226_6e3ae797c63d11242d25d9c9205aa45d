package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1595:uint = 4.291613146E9;
      ...
      private const const_1596:int = 10;
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_200.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_724;
               }
            }
            _loc4_++;
         }
      ...
      private function updateLocalizations() : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
         var _loc1_:IProductData = var_74.getProductData(var_68.localizationId);
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_724,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = var_1351;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = var_74.getFurnitureData(_loc6_,ProductTypeEnum.const_56);
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               var_74.purchaseProduct(var_600,var_68,var_897);
               dispose();
               break;
            case "cancel_button":
      ...
      {
         if(var_200 == null || true)
         {
            return;
         }
         var _loc1_:IItemListWindow = var_200.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(var_232) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_724);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_512[var_174]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_511[var_173]);
         var_74.purchaseProductAsGift(var_600,var_68,var_897,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
         ...
         switch(param1.type)
         {
            case WindowEvent.const_135:
               ...
               for each(_loc7_ in var_216)
               {
                  ...
                  if(_loc5_.length >= const_1596)
                  {
                     break;
                  }
               }
               updateSuggestions(_loc5_);
               var_1618 = _loc3_.text;
               break;
            case WindowMouseEvent.const_34:
               showSuggestions(false);
               if(var_1071)
               ...
               break;
            case WindowKeyboardEvent.const_625:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     highlightSuggestion(var_232 - 1);
                     break;
                  case Keyboard.DOWN:
                     highlightSuggestion(var_232 + 1);
                     break;
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = var_74.getProductData(var_68.localizationId);
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1351 = _loc1_.stuffTypes;
            var_512 = _loc1_.boxTypes;
            var_511 = _loc1_.ribbonTypes;
            var_724 = var_1351[0];
            var_174 = var_512[0];
            var_173 = var_511[0];
            initColorGrid();
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_200.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         _loc3_ = _loc2_.getListItemAt(var_232) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = getColor(var_232);
         }
         var_232 = param1;
         if(var_232 < 0)
         {
            var_232 = _loc2_.numListItems - 1;
         }
         if(var_232 >= _loc2_.numListItems)
         {
            var_232 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(var_232) as IWindowContainer;
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_200 == null)
         {
            var_200 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_421 == null)
         {
            var_421 = createWindow("suggestion_list_item") as IWindowContainer;
            var_421.procedure = suggestionsEventHandler;
         }
         if(var_200 == null || var_421 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_200.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_421.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
