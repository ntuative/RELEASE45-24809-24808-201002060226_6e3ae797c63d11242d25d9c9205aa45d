package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_166:String = "landscape";
      
      private static const const_168:String = "floor";
      
      private static const const_167:String = "wallpaper";
       
      
      private var var_1307:String = "InstantMessageErrorMessageParser";
      
      private var var_1110:Array;
      
      private var var_933:BitmapData = null;
      
      private var var_208:int = 0;
      
      private var var_620:int = 0;
      
      private var var_1306:String = "1.1";
      ...
      private var _floorType:String = "InstantMessageErrorMessageParser";
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_933 != null && var_932 != null)
         {
            setRoomImage(var_933,var_932);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_161.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_208 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_208];
                  if(_loc9_ != null)
                  {
                     var_1307 = _loc9_.@id;
                  }
         ...
         for each(_loc1_ in var_161.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_235];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_161.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[var_236];
               if(_loc13_ != null)
               {
                  var_1306 = _loc13_.@id;
               }
         ...
         switch(param1)
         {
            case const_167:
               ...
               for each(_loc8_ in var_161.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_619 = _loc8_.children().length();
                  }
               }
            ...
            case const_168:
               ...
               for each(_loc9_ in var_161.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_621 = _loc9_.children().length();
                  }
               }
            ...
            case const_166:
               ...
               for each(_loc10_ in var_161.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_620 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1307);
               }
               break;
            ...
            case "ctlg_landscape_pattern_next":
               changePattern(const_166,-1);
               break;
            case "ctlg_landscape_pattern_prev":
               changePattern(const_166,1);
               break;
            case "ctlg_landscape_color_prev":
               changeColor(const_166,-1);
               break;
            case "ctlg_landscape_color_next":
               changeColor(const_166,1);
               break;
            case "ctlg_buy_landscape":
               _loc3_ = var_1109[var_276];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1306);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1307,var_1306,64,this,"window_romantic_wide");
