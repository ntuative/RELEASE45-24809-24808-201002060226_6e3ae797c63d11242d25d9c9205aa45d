package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_1100:MarketPlaceOfferData;
      
      private const const_1387:int = 1;
      
      private const const_1604:int = 40;
      
      private var var_430:IWindowContainer;
      
      private const const_1386:int = 2;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         if(!var_430)
         {
            ...
            var_430 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_430)
         {
            return;
         ...
         updateStatusDisplay(const_1386,_loc2_.length);
         if(!var_358)
         {
            var_358 = new Timer(25);
            var_358.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_749 = 0;
         populateList();
         var_358.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_518)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_430 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_430.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_359.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_358)
         {
            var_358.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_358 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_749 >= var_518.length)
            {
               return true;
            }
            addListItem(var_518.getWithIndex(var_749));
            ++var_749;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_1100.offerId);
                  hideDetails();
            }
            return;
         }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_359));
            _loc7_.selection = 0;
         }
      }
