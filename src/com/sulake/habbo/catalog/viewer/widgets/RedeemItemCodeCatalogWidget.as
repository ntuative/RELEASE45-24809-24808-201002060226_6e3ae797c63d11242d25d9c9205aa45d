package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         if(var_1001 != null)
         {
            var_1001.removeEventListener(WindowKeyboardEvent.const_115,windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_1001 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1001 != null)
         {
            var_1001.addEventListener(WindowKeyboardEvent.const_115,windowKeyEventProcessor);
         }
      }
