   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      public function ItemGridCatalogWidget(param1:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_220,activateScrollbar);
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         {
            ++var_1450;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1450);
         }
      }
      
      override public function init() : void
      {
         var_889 = _window.findChildByName("itemGrid") as IItemGridWindow;
