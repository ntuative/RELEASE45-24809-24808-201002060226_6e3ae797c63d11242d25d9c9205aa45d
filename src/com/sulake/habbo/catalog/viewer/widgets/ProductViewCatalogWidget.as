package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1282:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1183.text = "${" + _loc3_.name + "}";
            var_1184.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1183.text = "${" + _loc2_.localizationId + "}";
            var_1184.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_378:
                  _loc4_ = var_1283.clone();
                  if(var_576 != null)
                  {
                     var_576.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_576,var_1282,var_1327);
                  }
                  break;
               ...
               case Offer.const_355:
                  ...
                  switch(_loc6_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_184:
                        ...
                        _loc4_ = new BitmapData(var_76.width,var_76.height,false,_loc10_);
                        _loc11_ = null;
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_288,AvatarAction.const_638);
                              _loc13_.appendAction(AvatarAction.const_659,_loc6_.productClassId);
      ...
      {
         var_1183 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1184 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_76 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1522 = new Point(var_76.x,var_76.y);
         var_576 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1282 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_576 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1327 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1283 = _loc2_.content as BitmapData;
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         {
            _loc7_ = _window.getChildIndex(var_76);
      ...
      private function retrievePreviewAsset(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.const_13,onPreviewImageReady);
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Point = null) : void
      {
         ...
         if(true)
         {
            var_76.bitmap = new BitmapData(var_76.width,var_76.height,true,16777215);
         }
         var_76.bitmap.fillRect(var_76.bitmap.rect,16777215);
         var _loc3_:Point = new Point((0 - param1.width) / 2,(0 - param1.height) / 2);
         var_76.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         var_76.invalidate();
         var_76.x = var_1522.x;
         var_76.y = var_1522.y;
         if(param2 != null)
