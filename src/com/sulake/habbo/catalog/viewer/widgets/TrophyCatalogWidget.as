package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_409.getWithIndex(var_195);
         if(_loc2_ != null)
         {
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         var_76.bitmap.copyPixels(param1,param1.rect,_loc2_,null,null,true);
         var_76.invalidate();
      }
      ...
      override public function init() : void
      {
         ...
         var _loc8_:* = null;
         super.init();
         var_76 = window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         ...
         _loc4_ = var_409.getWithIndex(var_195);
         if(_loc4_ != null)
         {
