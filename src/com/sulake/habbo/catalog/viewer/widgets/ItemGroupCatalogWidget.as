package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_534[var_959] as Array;
      ...
      {
         var _loc2_:Offer = var_534[var_959][var_1809];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_390 || _loc1_.pricingModel == Offer.const_355)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_57 || _loc3_.productType == ProductTypeEnum.const_56)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        {
                           var_960.push(_loc5_);
                           var_534.push(new Array());
                        }
                        _loc6_ = var_960.indexOf(_loc5_);
                        (var_534[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
         }
         for each(_loc2_ in var_534)
         {
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_534)
         {
            if(var_1809 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1809] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_959 = var_889.getGridItemIndex(param1.view);
