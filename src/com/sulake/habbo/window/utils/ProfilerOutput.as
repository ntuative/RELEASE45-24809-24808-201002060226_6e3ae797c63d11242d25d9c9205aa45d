package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_381.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_381.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_381.removeStopEventListener(refresh);
            var_381 = null;
            _windowManager = null;
            var_705 = null;
            _disposed = true;
