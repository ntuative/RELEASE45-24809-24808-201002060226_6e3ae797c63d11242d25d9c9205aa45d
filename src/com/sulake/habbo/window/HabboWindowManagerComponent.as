package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_330:uint = 3;
      ...
      private var var_1302:ProfilerOutput;
      
      private var var_705:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_182 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1304 = Component(param1).events;
            var_873 = new Array();
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_705 = new WindowRenderer(_loc4_);
         var_296 = new Array(const_330);
         var _loc6_:int = 0;
         while(_loc6_ < const_330)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_705,this,_localization,var_182,new Rectangle(0,0,var_182.stageWidth,var_182.stageHeight),this);
            var_296[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_366 = var_296[const_1108];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_366.getMouseCursor().defineCustomCursorType(MouseCursorType.const_309,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_366.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1187,_loc7_);
      }
      ...
      {
         return var_296[param1].getDesktopWindow().getChildAt(var_366.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1302 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1302 = new ProfilerOutput(_loc3_,this,var_705);
               var_1305 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1305);
      ...
      {
         return var_366.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_882.length > 0)
         {
            var_1304.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_330 - 1;
            while(_loc2_ >= 0)
            {
         ...
         var_1304.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_330)
         {
         ...
         if(WindowContext.var_882.length > 0)
         {
            WindowContext.var_882.flush();
         }
         if(WindowContext.var_1320.length > 0)
         {
            WindowContext.var_1320.flush();
         }
         var_1304.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_873[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_873[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_366.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
