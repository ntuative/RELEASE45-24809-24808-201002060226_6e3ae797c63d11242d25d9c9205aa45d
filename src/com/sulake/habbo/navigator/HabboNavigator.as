package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2333:Dictionary;
      ...
      private var var_1645:ISessionDataManager;
      
      private var var_1643:RoomCreateViewCtrl;
      
      private var var_1644:RoomThumbnailRenderer;
      
      private var var_187:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1081:RoomInfoViewCtrl;
      
      private var var_74:IHabboCatalog;
      
      private var var_354:Tabs;
      
      private var var_425:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_425 = new MainViewCtrl(this);
         var_1081 = new RoomInfoViewCtrl(this);
         var_1643 = new RoomCreateViewCtrl(this);
         var_1644 = new RoomThumbnailRenderer(this);
         var_992 = new GuestRoomPasswordInput(this);
         var_326 = new GuestRoomDoorbell(this);
         var_354 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_425.startSearch(Tabs.const_193,Tabs.const_287,param1);
         var_425.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_187 != null)
         {
            var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1645 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_425.startSearch(Tabs.const_219,Tabs.const_199);
         var_354.getTab(Tabs.const_219).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_425.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
