package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1644 = new RoomThumbnailRenderer(param1);
         var_925 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_159,var_108.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_159.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_159.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_925.refreshTags(_loc1_,var_108.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1644.refreshThumbnail(_loc1_,var_108.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_159 == null)
         {
            var_159 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_159.visible = true;
         Util.hideChildren(var_159);
         refreshRoomName(var_159,var_108);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_159,!true ? getEventCtg(var_108.categoryId) : getRoomCtg(var_108.categoryId));
         refreshRoomDesc(var_159,var_108);
         refreshExtraCont();
         refreshInfo(var_159,"trading_allowed",var_108.allowTrading);
         refreshInfo(var_159,"doormode_doorbell",false);
         refreshInfo(var_159,"doormode_password",false);
         Util.moveChildrenToColumn(var_159,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_159.height = Util.getLowestPoint(var_159);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_193,Tabs.const_185,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
