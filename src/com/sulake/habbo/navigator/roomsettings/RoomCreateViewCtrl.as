package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_841:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1263 = new Timer(100);
         var_1263.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_56 = new Array();
         var_56.push(new RoomLayout(false,104,"a"));
         var_56.push(new RoomLayout(false,94,"b"));
         var_56.push(new RoomLayout(false,36,"c"));
         var_56.push(new RoomLayout(false,84,"d"));
         var_56.push(new RoomLayout(false,80,"e"));
         var_56.push(new RoomLayout(false,80,"f"));
         var_56.push(new RoomLayout(true,80,"g"));
         var_56.push(new RoomLayout(true,74,"h"));
         var_56.push(new RoomLayout(false,416,"i"));
         var_56.push(new RoomLayout(false,320,"j"));
         var_56.push(new RoomLayout(false,448,"k"));
         var_56.push(new RoomLayout(false,352,"l"));
         var_56.push(new RoomLayout(false,384,"m"));
         var_56.push(new RoomLayout(false,372,"n"));
         var_56.push(new RoomLayout(true,416,"o"));
         var_56.push(new RoomLayout(true,352,"p"));
         var_56.push(new RoomLayout(true,304,"q"));
         var_56.push(new RoomLayout(true,336,"r"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_1016 = new TextFieldManager(_navigator,ITextFieldWindow(var_17.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1016.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_56.length)
         {
            _loc6_ = var_56[_loc4_];
            if(isAllowed(_loc6_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_56[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
         ...
         var_2068 = _navigator.data.hcMember;
      }
      ...
      {
         var_1016.goBackToInitialState();
         var_1016.input.textBackgroundColor = 4294967295;
         var_841 = var_56[0];
         if(var_2068 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_37,HabboWindowStyle.const_20,HabboWindowParam.const_50,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_1016.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_841.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1262 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1262 = true;
            _loc3_.y = 1;
