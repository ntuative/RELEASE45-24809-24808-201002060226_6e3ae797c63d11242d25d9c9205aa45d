package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1065:int = -16;
      
      private static const const_746:int = 32;
      
      private static const const_1063:int = 8;
      
      public static const const_348:int = 10;
      ...
      private var var_820:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_820 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_820.getImage(ThumbnailEditorModel.const_16,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1065,_loc4_.y + const_1064 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1961[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_820.getImage(ThumbnailEditorModel.const_19,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_820.getImage(ThumbnailEditorModel.const_19,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_820.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_746 + _loc3_,param2 * const_1063);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_348)
         {
            if(false)
            {
               refreshObj(param1,var_995[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1221 == null)
         {
            var_1221 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1221,var_1221.rect,new Point(0,0),null,null,true);
      }
   }
}
