package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2231:IWindowContainer;
      ...
      private var var_2232:IWindowContainer;
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1552,this._model.mode != ThumbnailEditorModel.const_36);
         setEnabled(var_1551,this._model.mode != ThumbnailEditorModel.const_16);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1552 = IButtonWindow(find("top_tab"));
         var_1551 = IButtonWindow(find("obj_tab"));
         var_2232 = IWindowContainer(find("tile_grid"));
         var_2231 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1552,onTopTabButton);
         Util.setProcDirectly(var_1551,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2232;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_348)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2231;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_37,HabboWindowStyle.const_20,HabboWindowParam.const_50,new Rectangle(0,0,param1.width,66)));
