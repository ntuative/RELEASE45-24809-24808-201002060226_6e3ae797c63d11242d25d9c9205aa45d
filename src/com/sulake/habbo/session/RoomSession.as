package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1017:UserDataManager;
      ...
      {
         if(var_30 == RoomSessionEvent.const_282 && _connection != null)
         {
            var_30 = RoomSessionEvent.const_75;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1017 as IUserDataManager;
      }
