package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1232:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_977:String = "group_badge";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1232:
               if(var_161 != null)
               {
                  _loc5_ = var_161.getKey("image.library.url","http://images.habbohotel.com/c_images/");
         ...
         if(_loc4_ != null)
         {
            ...
            _loc8_.addEventListener(AssetLoaderEvent.const_13,onBadgeImageReady);
         }
