package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_93:IItemListWindow;
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var_207 = _window.getListItemByName("info_border") as IBorderWindow;
         ...
         if(var_207 != null)
         {
            var_93 = var_207.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
         var _loc6_:IBitmapWrapperWindow = var_207.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = var_207.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = var_207.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = var_207.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = var_102.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = var_102.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         var_102.x = _loc5_.left - 0;
         var_102.y = _loc5_.top + (_loc5_.height - 0) / 2;
      }
      
      public function clearGroupBadge() : void
      {
         var _loc1_:IWindowContainer = var_93.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         var _loc2_:ITextWindow = var_93.getListItemByName("realname_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:IWindowContainer = var_93.getListItemByName("image_and_badges_container") as IWindowContainer;
      ...
      {
         if(var_93 == null || var_207 == null || var_53 == null)
         {
            return;
         }
         var_53.width = var_53.scrollableRegion.width;
         var_93.height = var_93.scrollableRegion.height;
         var_207.height = NaN;
         _window.width = Math.max(var_207.width,var_53.width);
      ...
      {
         var _loc2_:ITextWindow = var_93.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_93.getListItemByName("motto_spacer") as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = var_93.getListItemByName("tags_container") as IWindowContainer;
         var _loc4_:IWindowContainer = var_93.getListItemByName("tags_spacer") as IWindowContainer;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:ITextWindow = var_93.getListItemByName("handitem_txt") as ITextWindow;
         var _loc3_:IWindowContainer = var_93.getListItemByName("handitem_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:ITextWindow = var_93.getListItemByName("name_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createBadgeDetails() : void
      {
         ...
         var_102 = _widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(var_102 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_847:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_959:
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         createBadgeDetails();
         _loc6_ = var_102.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = "${badge_name_" + _loc5_ + "}";
         }
         _loc6_ = var_102.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         var_102.x = _loc7_.left - 0;
         var_102.y = _loc7_.top + (_loc7_.height - 0) / 2;
      }
      ...
      {
         var _loc2_:ITextWindow = var_93.getListItemByName("xp_text") as ITextWindow;
         var _loc3_:IWindowContainer = var_93.getListItemByName("xp_spacer") as IWindowContainer;
         if(_loc2_ == null || _loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc3_:IWindowContainer = var_93.getListItemByName("image_and_badges_container") as IWindowContainer;
