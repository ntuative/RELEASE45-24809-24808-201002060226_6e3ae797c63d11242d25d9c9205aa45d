package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_82 && param1.type != WindowMouseEvent.const_530)
         {
            return;
         }
      ...
      {
         return int(var_1406 * (Number(param1 - var_626) / (var_939 - var_626)));
      }
      ...
      {
         return int(param1 / var_1406 * (var_939 - var_626)) + var_626;
      }
   }
}
