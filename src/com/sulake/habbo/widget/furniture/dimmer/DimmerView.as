package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_37,HabboWindowStyle.const_20,0 | 0,new Rectangle(const_1020,const_1019,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(var_342 != null)
         {
            var_342.setValue(var_1030);
         }
         var_407 = colors.indexOf(_loc2_.color);
         if(var_490 != null)
         {
            var_490.setSelectedColorIndex(var_407);
         }
