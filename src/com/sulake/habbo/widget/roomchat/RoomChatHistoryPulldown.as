package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_721:int = 150;
      
      private static const const_720:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_26 = param3;
         var_1609 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1350 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1608 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1349 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1348 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1605 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1606 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_61 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_20,HabboWindowParam.const_50,new Rectangle(0,0,param3.width,param3.height - const_53),null,0,0) as IBitmapWrapperWindow;
         var_26.addChild(var_61);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_37,HabboWindowStyle.const_20,HabboWindowParam.const_22,new Rectangle(0,0 - const_53,param3.width,const_53),null,0) as IWindowContainer;
         var_26.addChild(_window);
         var_91 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_456,HabboWindowStyle.const_23,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_53),null,0) as IRegionWindow;
         if(var_91 != null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_425:
               var_61.blend += param1 / const_720;
               _window.blend += param1 / const_720;
               if(false)
               {
                  state = const_302;
               }
               break;
            case const_732:
               var_61.blend = 0 - param1 / const_721;
               _window.blend = 0 - param1 / const_721;
               if(true)
               {
                  state = const_174;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(var_91 != null)
         {
            var_91.x = 0;
            var_91.y = 0 - const_53;
            var_91.width = 0 - var_1607;
         }
         if(var_61 != null)
         {
            var_61.rectangle = var_26.rectangle;
            var_61.height = 0 - const_53;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1604 == _window.width)
         {
            return;
         }
         var_1604 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1609.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1350.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1350.clone(),_loc9_);
