package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_326:int = 10;
      
      private static const const_1046:Number = 18;
      
      private static const const_1400:Number = 10;
      
      private static const const_1401:Number = 8;
      ...
      {
         var_1144 = param1.chatType;
         var_958 = param1.userId;
         var_769 = param1.userName;
         var_957 = param1.userCategory;
         _message = param1.text;
         var_1145 = param1.userX;
         var_179 = param1.userImage;
         var_956 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1144)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_113:
               ...
               break;
            case RoomWidgetChatUpdateEvent.const_80:
               _loc1_ = "bubble_shout";
               break;
         ...
         if(var_179 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_179.height);
         }
         ...
         if(var_179 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_179.width;
               _loc28_.height = var_179.height;
               _loc28_.bitmap = new BitmapData(var_179.width,var_179.height,true,0);
               _loc28_.bitmap.copyPixels(var_179,var_179.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_372 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_179.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_956 != 0)
            {
               _loc30_ = uint(var_956 >> 16 & 255);
               _loc31_ = uint(var_956 >> 8 & 255);
               _loc32_ = uint(var_956 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_326;
            }
            else
            {
               _loc19_.text = var_769 + ":";
               _loc19_.y += var_372;
               _loc19_.width = _loc19_.textWidth + const_326;
               _width += _loc19_.textWidth + const_326;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1144 == RoomWidgetChatUpdateEvent.const_232)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_769);
            }
            else if(var_1144 == RoomWidgetChatUpdateEvent.const_222)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_769);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_326 + _loc20_.textWidth + const_473;
            _loc37_ = new Matrix();
