package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_469:int = 25;
      
      private static const const_1045:int = 6000;
      
      private static const const_1041:int = 9;
      
      private static const const_735:int = 4000;
      ...
      private static const const_258:int = 9;
      
      private static const const_471:int = 8;
      
      private static const const_325:int = 0;
      
      private static const const_470:int = (const_471 + const_325) * const_77 + const_77;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_211 = new Array();
         var_634 = new Point();
         var_139 = const_470 + const_258;
         super(param1,param2,param3);
         var_1793 = param5;
         var_26 = param1.createWindow("chat_container","",HabboWindowType.const_37,HabboWindowStyle.const_20,HabboWindowParam.const_23,new Rectangle(0,0,200,var_139 + RoomChatHistoryPulldown.const_53),null,0) as IWindowContainer;
         var_26.background = true;
         var_26.color = 33554431;
         var_26.tags.push("room_widget_chat");
         var_316 = param1.createWindow("chat_contentlist","",HabboWindowType.const_840,HabboWindowStyle.const_23,0 | 0,new Rectangle(0,0,200,var_139),null,0) as IItemListWindow;
         var_26.addChild(var_316);
         var_122 = param1.createWindow("chat_active_content","",HabboWindowType.const_37,HabboWindowStyle.const_23,HabboWindowParam.const_50,new Rectangle(0,0,200,var_139),null,0) as IWindowContainer;
         var_316.addListItem(var_122);
         var_22 = new RoomChatHistoryViewer(this,param1,var_26,param2);
         var_1792 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_709,onRoomViewUpdate);
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_643,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_139 = const_470 + const_258;
         var_26.height = var_139 + var_22.pulldownBarHeight;
         var_316.width = 0 - 0;
         var_316.height = var_139;
         var_122.width = 0 - 0;
         if(historyViewerActive())
         {
            var_122.height = getTotalContentHeight() + const_258;
         }
         else
         {
            var_122.height = var_139;
         }
         var_316.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_779)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_57.length > const_1042 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_635 = getTimer() + const_735;
         }
         else
         {
            if(false && false)
            {
               var_531 = getItemSpacing(_itemList["-1"],var_57[0]);
            }
            else
            {
               var_531 = const_77;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_634.x) * var_767;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = 0 - const_734;
         var _loc6_:Number = 0 + const_734 - 0;
      ...
      {
         return "chat_" + var_1793.toString() + "_item_" + (var_1794++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_709,onRoomViewUpdate);
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_643,onRoomViewUpdate);
      }
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_439);
            if(_loc2_ == -1)
            {
               param1.y = getAreaBottom() - (_loc3_ + 1) * const_77 - const_258;
            }
            else
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1044 * const_1043;
            if(_loc2_ + var_633 > var_531)
            {
               _loc2_ = var_531 - var_633;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1412 == 0)
            {
               var_1412 = param1.scale;
            }
            else
            {
               var_767 = param1.scale / var_1412;
            }
         }
         if(param1.positionDelta != null)
         {
            var_634.x += param1.positionDelta.x / var_767;
            var_634.y += param1.positionDelta.y / var_767;
         }
         if(param1.rect != null)
         {
            if(var_22 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1792)
         {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_439,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = var_439;
               if(_loc1_.aboveLevels > const_471 + const_325 + 2)
               {
                  _loc1_.aboveLevels = const_471 + const_325 + 2;
               }
               var_439 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_139 = param1 - 0;
         var_26.height = var_139 + RoomChatHistoryPulldown.const_53;
         if(var_22 != null)
         {
            var_22.containerResized(var_26.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
         ...
         var _loc6_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_305,param1,param2);
         messageListener.processWidgetMessage(_loc6_);
         var _loc7_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_532,param1,param3,param4);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_325 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1045)
               {
