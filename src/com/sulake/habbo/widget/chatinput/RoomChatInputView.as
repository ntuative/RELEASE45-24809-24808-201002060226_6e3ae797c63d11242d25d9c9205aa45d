package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1022:int = 20;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_926 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1722 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1721 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_618 = new Timer(1000,1);
         var_618.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_752 = new Timer(5000,1);
         var_752.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_115,windowKeyEventProcessor);
         ...
         _window.addEventListener(WindowEvent.const_450,onWindowMoved);
         var_1105 = true;
         var_117 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1720 = _loc2_.width + const_473 + _loc6_.width + const_1022;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1021,_loc8_.width) + const_473);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_926 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_117 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_432);
