package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_157:IWidgetAvatarEffect;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_799 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_157.duration);
               var_799.width = _loc2_ * var_375;
            }
            else
            {
               var_799.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         setTimeLeft();
         var_799 = _window.findChildByName("loader_bar");
         if(var_799 != null)
         {
            var_375 = var_799.width;
            var_166.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_157.icon);
         }
      }
