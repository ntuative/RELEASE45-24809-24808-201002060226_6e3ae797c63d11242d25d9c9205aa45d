package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_587:String = "me_menu_settings_view";
      
      private static const const_733:int = 10;
      
      public static const const_701:String = "me_menu_effects_view";
      
      public static const const_111:String = "me_menu_top_view";
      
      public static const const_1117:String = "me_menu_rooms_view";
      
      public static const const_900:String = "me_menu_dance_moves_view";
      ...
      public function MeMenuWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         _config = param5;
         var_937 = new Point(0,0);
         _eventDispatcher = param4;
         if(param5 != null && false)
         {
            var_1741 = param5.getKey("client.news.embed.enabled","ItemDataUpdateMessageEvent") == "true";
         }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_480,onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_508,onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_493,onToolbarClicked);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_301,onUpdate);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_679,onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_405,onShowAvatarEditorClubPromo);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_884,onHideAvatarEditorClubPromo);
         ...
         param1.addEventListener(RoomWidgetAvatarActionUpdateEvent.const_490,onAvatarActionEvent);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_209,onUserInfo);
         param1.addEventListener(RoomWidgetSettingsUpdateEvent.const_311,onSettingsUpdate);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(var_25.window.name == const_587)
         {
      ...
      private function onCreditBalance(param1:RoomWidgetCreditBalanceUpdateEvent) : void
      {
         ...
         var_1404 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",var_1404.toString());
      }
      
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         var _loc2_:* = null;
         if(!(var_237 && var_25.window.name == const_233))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_483);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_480,onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_508,onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_493,onToolbarClicked);
         ...
         param1.removeEventListener(RoomWidgetAvatarActionUpdateEvent.const_490,onAvatarActionEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_679,onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_405,onShowAvatarEditorClubPromo);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_884,onHideAvatarEditorClubPromo);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_209,onUserInfo);
         param1.removeEventListener(RoomWidgetSettingsUpdateEvent.const_311,onSettingsUpdate);
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_422:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + var_237 + " view: " + var_25.window.name);
               if(var_237 != true || var_25.window.name != const_111)
               {
                  return;
               }
               (var_25 as MeMenuMainView).setIconAssets("clothes_icon",const_111,"clothes_highlighter_blue");
               break;
      ...
      {
         var _loc2_:* = var_1122 > 0;
         var_1122 = param1.daysLeft;
         var_1740 = param1.periodsLeft;
         var_1742 = param1.pastPeriods;
         var_1743 = param1.allowClubDances;
      ...
      {
         if(var_25 != null && var_25.window.name != const_233)
         {
            hide();
         }
      }
      ...
      private function onShowAvatarEditorClubPromo(param1:RoomWidgetAvatarEditorUpdateEvent) : void
      {
         ...
         if(var_25 != null && var_25.window.name == const_233)
         {
            if(param1.promoMode == RoomWidgetAvatarEditorUpdateEvent.const_923)
            {
               var_85 = new ClubPromoView(this,param1.promoImageUrl,ClubPromoView.const_1247);
            }
            else
            {
               var_85 = new ClubPromoView(this,param1.promoImageUrl,ClubPromoView.const_358);
            }
            _loc2_ = _mainContainer.getChildByName(var_25.window.name);
            if(_loc2_ != null)
            {
               var_85.window.x = _loc2_.width + const_733;
      ...
      private function onUpdateEffects(param1:RoomWidgetUpdateEffectsUpdateEvent) : void
      {
         ...
         if(var_25 != null && var_25.window.name == const_701)
         {
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            _mainContainer = windowManager.createWindow("me_menu_main_container","",HabboWindowType.const_1257,HabboWindowStyle.const_926,HabboWindowParam.const_23,new Rectangle(0,0,170,260)) as IWindowContainer;
      ...
      public function updateSize() : void
      {
         if(var_25 != null)
         {
            var_937.x = var_25.window.width + 10;
            var_937.y = var_25.window.height;
            var_25.window.x = 5;
            var_25.window.y = 0;
            _mainContainer.width = var_937.x;
            _mainContainer.height = var_937.y;
            if(var_85 != null)
            {
               _mainContainer.width = var_85.window.x + var_85.window.width + const_733;
            }
         }
      }
