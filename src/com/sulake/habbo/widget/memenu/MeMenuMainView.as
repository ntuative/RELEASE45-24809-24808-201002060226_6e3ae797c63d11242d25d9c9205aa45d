      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "dance":
               ...
               _widget.changeView(MeMenuWidget.const_900);
               break;
            case "wave":
               if(false)
               {
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_917));
            ...
            case "effects":
               ...
               _widget.changeView(MeMenuWidget.const_701);
               break;
            case "rooms":
            ...
            case "news":
               ...
               break;
            case "credits":
               _loc4_ = _widget.config.getKey("client.credits.embed.enabled","ItemDataUpdateMessageEvent") == "true";
               if(false && _loc4_)
               {
