package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1018:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_500,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_105,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_98,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_500,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_105,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_98,onDoorbellHandled);
      }
