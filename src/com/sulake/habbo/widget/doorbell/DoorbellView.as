package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var _loc1_:XmlAsset = var_326.assets.getAssetByName("doorbell") as XmlAsset;
         var_45 = (var_326.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_45 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         var_43 = var_45.findChildByName("user_list") as IItemListWindow;
         var_45.visible = false;
      ...
      {
         var _loc6_:* = null;
         var _loc3_:XmlAsset = var_326.assets.getAssetByName("doorbell_list_entry") as XmlAsset;
         var _loc4_:IWindowContainer = var_326.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function update() : void
      {
         ...
         if(var_43 != null)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < var_326.users.length)
            {
               var_43.addListItem(createListItem(var_326.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
