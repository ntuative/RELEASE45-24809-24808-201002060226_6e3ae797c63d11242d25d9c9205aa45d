package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_747:uint = 11;
      ...
      private var var_827:IHabboWindowManager;
      ...
      private var var_160:IHabboFriendList;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1235 = new Array(const_747);
         var _loc4_:int = 0;
         while(_loc4_ < const_747)
         {
            var_1235[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1270,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1345,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1118,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_710,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_805,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1116);
               break;
            case HabboCommunicationEvent.const_699:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_161)
         {
            Component(var_161).events.addEventListener(HabboConfigurationEvent.const_139,onConfigurationLoaded);
            if(var_219 != null)
            {
               var_219.configuration = var_161;
            }
            if(var_218 != null)
            {
               var_218.configuration = var_161;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_450.events.addEventListener(AdEvent.const_407,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!var_1985)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1122);
            var_1985 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_805,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_710,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_699,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_482,onHotelViewEvent);
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_437:
               var_1234.registerWarning(LagWarningLogger.const_786);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_827)
            {
               var_827.release(new IIDHabboWindowManager());
               var_827 = null;
            }
            if(var_450)
            {
               var_450.release(new IIDHabboAdManager());
               var_450 = null;
            }
            if(_navigator)
            {
            ...
            if(var_160)
            {
               if(true)
               {
                  Component(var_160).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
                  Component(var_160).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
                  Component(var_160).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
                  Component(var_160).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
                  Component(var_160).events.removeEventListener(HabboFriendListTrackingEvent.const_317,onFriendlistTrackingEvent);
               }
               var_160.release(new IIDHabboFriendList());
               var_160 = null;
            }
            if(var_390)
            {
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_437,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         trackLoginStep(HabboLoginTrackingStep.const_139);
         if(var_161)
         {
            Component(var_161).events.removeEventListener(HabboConfigurationEvent.const_139,onConfigurationLoaded);
         }
      }
      ...
      {
         var_827 = IHabboWindowManager(param2);
         if(var_827)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_1003 > -1 && _loc2_ < var_1003)
         {
            ++var_1476;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1476);
         }
         if(var_1003 > -1 && _loc2_ - var_1003 > 15000)
         {
            ++var_1477;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1477);
         }
         var_1003 = _loc2_;
         if(var_218 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_437,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_227,onRoomAdClick);
      }
      ...
      {
         var_160 = param2 as IHabboFriendList;
         Component(var_160).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,onFriendlistTrackingEvent);
         Component(var_160).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,onFriendlistTrackingEvent);
         Component(var_160).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,onFriendlistTrackingEvent);
         Component(var_160).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,onFriendlistTrackingEvent);
         Component(var_160).events.addEventListener(HabboFriendListTrackingEvent.const_317,onFriendlistTrackingEvent);
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_482)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1154);
         }
         else if(param1.type == HabboHotelViewEvent.const_459)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1241);
         }
         else if(param1.type == HabboHotelViewEvent.const_43)
         {
            trackLoginStep(HabboLoginTrackingStep.const_1298);
         }
      }
   }
}
