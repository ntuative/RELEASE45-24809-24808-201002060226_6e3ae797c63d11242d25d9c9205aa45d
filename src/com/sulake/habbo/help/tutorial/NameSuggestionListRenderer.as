package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      {
         var _loc2_:ITextWindow = var_41.buildXmlWindow("tutorial_name_suggestion_item") as ITextWindow;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         {
            _offsetX = 0;
            var_747 += param1.height + const_1603;
            return fit(param1);
         }
         param1.offset(_offsetX,var_747);
         _offsetX += param1.width + const_1602;
         return true;
      }
