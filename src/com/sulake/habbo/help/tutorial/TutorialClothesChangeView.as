package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_41.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_29,onShowMenuEvent);
         var_41.prepareForTutorial();
      }
      
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_145,HabboToolbarIconEnum.MEMENU);
         if(param1)
         {
         ...
         var_41.help.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_cancel":
               ...
               {
                  var_41.showView(TutorialUI.const_66);
               }
         }
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_29)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_41.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_352));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_568 = var_41.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_568.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
            _loc2_ = BitmapDataAsset(var_41.assets.getAssetByName("tutorial_highlight_blue_arrow"));
            _loc1_.bitmap = (_loc2_.content as BitmapData).clone();
         }
         var_41.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.MEMENU_ARROW,var_568));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_41.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_29,onShowMenuEvent);
      }
   }
}
