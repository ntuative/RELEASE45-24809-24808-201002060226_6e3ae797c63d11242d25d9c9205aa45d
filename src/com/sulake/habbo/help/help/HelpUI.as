package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1877:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","24809-24808-201002060148");
         var_187 = param5;
         var_96 = new Map();
         var_96.add(HabboHelpViewEnum.const_1231,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_121,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_403,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_223,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_172,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_568,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         ...
         var_96.add(HabboHelpViewEnum.const_588,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_195,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_96.add(HabboHelpViewEnum.const_813,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_96.add(HabboHelpViewEnum.const_551,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1442 = 0 - _loc3_.width;
         var_1441 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_242 == HabboHelpViewEnum.const_121 || false)
         {
            return;
         }
         if(var_382 == null)
         {
            ...
            var_382 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_382 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_382 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_382 as IWindow);
      ...
      {
         return var_96.getValue(var_242);
      }
      ...
      {
         var_1879 = param1;
         var _loc2_:IHelpViewController = var_96.getValue(HabboHelpViewEnum.const_121) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_971:
               showUI(HabboHelpViewEnum.const_813);
               break;
            case CallForHelpResultEnum.const_903:
      ...
      {
         var _loc3_:* = null;
         if(var_242 == HabboHelpViewEnum.const_121)
         {
            return;
         }
         if(true)
         {
            ...
            var_545.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_545.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_382.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_545[1],var_545[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_545[0],var_545[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1441;
         _window.width = _loc1_.width + var_1442;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_242);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_187 != null)
            {
               var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_27.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_586));
      }
