package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         var_703 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_704 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_132 = new Map();
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(var_704.hasItem(param1))
         {
            var_704.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
