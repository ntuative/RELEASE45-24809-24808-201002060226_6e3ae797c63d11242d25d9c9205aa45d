package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_492:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(var_491 != null)
         {
            ...
            {
               _loc2_ = var_491.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_491.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_698.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_295:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_85);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_85);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_491.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_698.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_593,RoomWidgetChatSelectAvatarMessage.const_532];
      }
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_130,_container.roomSession,0,"Version 24809-24808-201002060148");
                     ...
                     switch(_loc3_.chatType)
                     {
                        case RoomWidgetChatMessage.const_106:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_80:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_862 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_862);
            }
            if(var_492 == null)
            {
               var_493.x = 0;
               var_493.y = 0;
               var_493.z = 0;
               var_492 = _loc4_.getScreenPoint(var_493);
               var_862 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_493.x = 0;
            ...
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_492.x || _loc8_.y != var_492.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_492,_loc5_));
