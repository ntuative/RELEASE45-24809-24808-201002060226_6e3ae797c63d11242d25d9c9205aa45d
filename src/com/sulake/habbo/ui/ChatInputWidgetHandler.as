package com.sulake.habbo.ui
{
   ...
   public class ChatInputWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetChatInputWidgetMessage.const_677);
         _loc1_.push(RoomWidgetChatTypingMessage.const_505);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatInputWidgetMessage.const_677:
               ...
               break;
            case RoomWidgetChatTypingMessage.const_505:
      ...
      private function positionWindow(param1:IWindowContainer) : void
      {
         ...
         var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_654,HabboToolbarIconEnum.CHATINPUT,param1));
