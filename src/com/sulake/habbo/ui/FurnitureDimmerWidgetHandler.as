package com.sulake.habbo.ui
{
   ...
   public class FurnitureDimmerWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDimmerPresetsEvent.const_423:
            ...
            case RoomEngineObjectEvent.const_69:
               _container.events.dispatchEvent(new RoomWidgetDimmerUpdateEvent(RoomWidgetDimmerUpdateEvent.const_833));
         }
      }
      
      public function getWidgetMessages() : Array
      {
         return [RoomWidgetFurniToWidgetMessage.const_641,RoomWidgetDimmerSavePresetMessage.const_512,RoomWidgetDimmerChangeStateMessage.const_481,RoomWidgetDimmerPreviewMessage.const_717];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_641:
               ...
               break;
            case RoomWidgetDimmerSavePresetMessage.const_512:
               if(validateRights())
               {
               ...
               break;
            case RoomWidgetDimmerChangeStateMessage.const_481:
               if(validateRights())
               {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomSessionDimmerPresetsEvent.const_423);
         _loc1_.push(RoomEngineDimmerStateEvent.DIMMER_STATE);
         _loc1_.push(RoomEngineObjectEvent.const_69);
         return _loc1_;
      }
