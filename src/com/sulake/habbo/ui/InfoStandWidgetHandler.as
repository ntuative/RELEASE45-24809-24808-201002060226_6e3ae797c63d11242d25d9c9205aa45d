package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_93,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_93,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_12:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_573);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_273);
                  if(param1.category == RoomObjectCategoryEnum.const_14)
                  {
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_791);
            ...
            case RoomObjectCategoryEnum.const_18:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_402)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_846)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_554);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_212)
               {
                  ...
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_959;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1279);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_544.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_33);
            var_544.add(_loc2_.petId,_loc5_);
         }
      ...
      {
         return [RoomSessionUserBadgesEvent.const_89];
      }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_335);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_484);
         _loc1_.push(RoomWidgetFurniActionMessage.const_562);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_488);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_531);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1253);
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_89:
      ...
      public function dispose() : void
      {
         ...
         if(var_544 != null)
         {
            _loc1_ = var_544.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_544.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_387)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_575:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_850,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_534:
               ...
               break;
            case RoomWidgetUserActionMessage.const_335:
            ...
            case RoomWidgetUserActionMessage.const_537:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_484:
            ...
            case RoomWidgetFurniActionMessage.const_234:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_562:
            ...
            case RoomWidgetUserActionMessage.const_375:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_488:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_531:
