   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_809,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_646,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_646,onFigureUpdate);
         ...
         if(var_8 != null)
         {
            (var_8 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_801,onAvatarEffectsChanged);
            (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_622,onHabboClubSubscriptionChanged);
         }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_570);
         _loc1_.push(RoomWidgetDanceMessage.const_521);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_577);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_563);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_619);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_553);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_711);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_651);
         _loc1_.push(RoomWidgetStopEffectMessage.const_583);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1203);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_951);
         ...
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_603);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_483);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_499);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_652);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1195);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_483:
               ...
               break;
            case RoomWidgetWaveMessage.const_570:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_521:
               if(_container != null && false)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_577:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_563:
               if(var_8 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_619:
               if(var_8 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_651:
               ...
               {
                  var_74.openCatalogPage(CatalogPageName.const_271,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_711:
               ...
               if(var_8 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_974:
                        var_74.openCatalogPage(CatalogPageName.const_1152,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_858:
                        var_8.toggleInventoryPage(InventoryCategory.const_215);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1289:
                        var_8.toggleInventoryPage(InventoryCategory.const_52);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_583:
            ...
            case RoomWidgetSetToolbarIconMessage.const_880:
               ...
               {
                  case RoomWidgetSetToolbarIconMessage.const_1336:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.widgetType);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_951:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_603:
               if(_container != null)
               {
            ...
            case RoomWidgetToolbarMessage.const_615:
               ...
               if(var_187)
               {
                  var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_29,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_8 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_612:
               ...
               if(var_187 && false)
               {
                  var_187.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_430,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_690:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_405,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_923));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_405,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1218));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_524));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_499:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_652:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_311,_container.soundManager.volume));
               break;
            ...
            case RoomWidgetAvatarEditorMessage.const_702:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_617));
               }
               break;
            default:
