package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_2183:BitmapData = null;
      ...
      private var var_2184:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_407,0,0,_loc4_,var_1541,var_2184,var_2183));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2182 = int(_config.getKey("interstitial.interval","30000"));
         var_2185 = int(_config.getKey("interstitial.show.time","5000"));
         ...
         if(_loc3_ != "" && _loc4_ != "")
         {
            ...
            _loc7_.addEventListener(AssetLoaderEvent.const_13,adWarningLeftReady);
            _loc6_ = new URLRequest(_loc4_);
            _loc7_ = _assets.loadAssetFromFile("adWarningRight",_loc6_,"image/png");
            _loc7_.addEventListener(AssetLoaderEvent.const_13,adWarningRightReady);
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1296 = _loc2_.imageUrl;
         var_1541 = _loc2_.clickUrl;
         if(var_1296 != "" && var_1541 != "")
         {
            _loc3_ = var_1296;
            ...
            _loc4_ = new URLRequest(var_1296);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_13,roomAdImageReady);
         }
      }
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(var_1297 != "")
         {
            ...
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
            _loc5_.addEventListener(AssetLoaderEvent.const_13,interstitialLoaderEventHandler);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_396,0,0,param1.bitmapData,var_2181));
            var_701 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2183 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1542 > 0 && var_1540 >= var_1542)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_701;
         if(_loc1_ > var_2182)
         {
            ++var_1540;
      ...
      {
         var_578 = param2 as IHabboCommunicationManager;
         if(var_578 == null)
         {
            return;
         }
         _connection = var_578.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_462));
         }
      }
      ...
      private function interstitialLoaderEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AssetLoaderEvent.const_13:
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2184 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
