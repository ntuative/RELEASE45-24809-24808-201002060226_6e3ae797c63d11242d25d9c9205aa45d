package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_855:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_582)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_401)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_63.getParts(param1,(var_855 as AvatarImage).getFigure(),_loc6_,var_1295,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_63.getCanvas(var_183,var_1295);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1164[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_867 || _loc32_ == AvatarAction.const_545) && (_loc6_ == AvatarBodyPartType.const_283 || _loc6_ == AvatarBodyPartType.const_1240 || _loc6_ == AvatarBodyPartType.const_1182) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_183 == AvatarScaleType.const_33)
            {
               _loc30_.x += 67;
            }
            else
