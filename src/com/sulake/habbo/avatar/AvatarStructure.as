package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2211:PartOffsetData;
      
      private var var_875:AvatarActionManager;
      
      private var var_147:IAssetLibrary;
      
      private var var_2295:IAssetLibrary;
      
      private var var_1335:Boolean = false;
      
      private var var_2210:AvatarRenderManager;
      
      private var var_499:FigureData;
      ...
      private var var_1546:AvatarStructureDownloadSet;
      
      private var var_706:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_147 = param2;
         var_2295 = param3;
         var_499 = new FigureData();
         var_410 = new PartSetsData();
         _animationData = new AnimationData();
         var_1546 = new AvatarStructureDownloadSet();
         var_706 = new AnimationManager();
         var_707 = param4;
         var_2211 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_875.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_875.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_875.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_706.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1280[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_875.getDefaultActionType();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc8_ = var_706.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_499.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_499.getPalette(_loc23_.paletteID);
               if(_loc24_)
               {
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.const_76:
               var_1546.add(new AvatarStructureDownload(var_147,_loc5_,var_499));
               break;
            case AvatarType.PET:
         }
         var_1546.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_706.getAnimation(param1);
      }
      ...
      {
         var_875 = new AvatarActionManager(var_147,var_707);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_147.hasAsset("dance" + _loc1_))
         {
            ...
            var_706.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = var_499.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = var_499.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return var_875.sortActions(param1);
      }
   }
}
