package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         var_1396 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         var_1724 = parseInt(_loc2_,16);
         var_1725 = parseInt(_loc3_,16);
         _rgb = parseInt(_loc2_,16);
         var_1398 = _rgb >> 16 & 255;
         var_1397 = _rgb >> 8 & 255;
         _b = _rgb >> 0 & 255;
         var_1532 = var_1398 / 255 * 1;
         var_1533 = var_1397 / 255 * 1;
         var_1534 = _b / 255 * 1;
         if(var_1396 == 37)
         {
         ...
         _colorTransform = new ColorTransform(var_1532,var_1533,var_1534,_alphaMultiplier);
         var_931 = generatePaletteMapForGrayscale(var_1725,var_1724);
      }
      
      public function get reds() : Array
      {
         return var_931.getValue("reds") as Array;
      }
      ...
      {
         return var_931.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_931.getValue("greens") as Array;
      }
      ...
      {
         return var_931.getValue("alphas") as Array;
      }
