package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_435:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1252 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_435 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_435.bitmap = new BitmapData(var_435.width,var_435.height,true,16777215);
         var_435.bitmap.copyPixels(var_1252,var_1252.rect,new Point(0,0 - 0 - 8));
         var_435.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
