package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.x = _y * param1.z - var_78 * param1.y;
         _loc2_.y = var_78 * param1.x - var_79 * param1.z;
      ...
      {
         return Math.sqrt(var_79 * var_79 + _y * _y + var_78 * var_78);
      }
      ...
      {
         return var_79 * param1.x + _y * param1.y + var_78 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_79 + "," + _y + "," + var_78 + "," + var_928 + ")";
      }
