package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_488:Matrix4x4;
      
      private var var_856:Vector3D;
      
      private var var_156:Dictionary;
      
      private var var_695:Dictionary;
      
      private var var_1525:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_856 = new Vector3D(0,0,10,0);
         super();
         var_488 = new Matrix4x4();
         var_695 = new Dictionary();
         var_1525 = new AvatarSet(param1.avatarset[0]);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            var_488 = var_488.identity().rotateY(param3);
            return _loc5_.getParts(var_488,var_856,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1525.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         var_488 = var_488.identity().rotateY(param2);
         for each(_loc8_ in _loc6_)
         {
            _loc8_.applyTransform(var_488);
            _loc11_ = _loc8_.getDistance(var_856);
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1525.findAvatarSet(param1);
         if(_loc3_ != null)
         {
