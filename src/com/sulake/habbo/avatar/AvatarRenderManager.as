package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_617:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_274.getValue(AvatarType.const_76) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_274.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_617 = new PetDataManager(_loc1_,_loc3_);
         var_922 = new PaletteManager(_loc1_,_loc3_);
         var _loc4_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_617.populateFigureData(_loc4_);
      ...
      {
         var _loc5_:String = var_617.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_274.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_274.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_274.getValue(AvatarType.const_76) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_16,param1,param2,AvatarType.const_76);
      }
