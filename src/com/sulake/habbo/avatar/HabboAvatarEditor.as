package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_945:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_945.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_943)
         {
            ...
            var_628["null"] = new FigureData(this);
            var_628["null"] = new FigureData(this);
            _loc1_ = var_628["null"];
            _loc2_ = var_628["null"];
            ...
            var_306 = new Map();
            var_306.add(AvatarEditorCategory.const_916,new GenericModel(this));
            var_306.add(AvatarEditorCategory.const_28,new HeadModel(this));
            var_306.add(AvatarEditorCategory.const_283,new TorsoModel(this));
            var_306.add(AvatarEditorCategory.const_1194,new LegsModel(this));
            var_306.add(AvatarEditorCategory.const_507,new WardrobeModel(this));
            var_943 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_306.getValue(AvatarEditorCategory.const_507);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_306.getValue(AvatarEditorCategory.const_507);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_945.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1125)
               {
                  _loc19_ = true;
               }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_366 == null)
            {
               var_366 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_37,HabboWindowStyle.const_20,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_366.addChild(_view.window);
               var_366.center();
               var_366.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_916);
         if(var_161 != null)
         {
            urlString = var_161.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1124 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_8 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_622,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_945 = var_1124.getFigureData(AvatarType.const_76);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_944 = param3;
         var _loc4_:FigureData = var_628[param2];
         if(_loc4_ == null)
         {
            return;
         }
