package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_97,param2,param3);
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_128,param2,param3);
         attachImages();
         switchCategory(FigureData.const_97);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_671[var_1416];
         if(_loc2_ == null)
         {
            return;
         }
