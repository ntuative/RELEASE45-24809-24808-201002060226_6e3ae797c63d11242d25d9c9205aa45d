package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_123,param2,param3);
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_153,param2,param3);
         var_671["null"] = new AvatarEditorGridView(param1,FigureData.const_122,param2,param3);
         attachImages();
