package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_965:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var _assets:IAssetLibrary;
      
      private var var_1709:IStructureData;
      ...
      public function AvatarStructureDownload(param1:IAssetLibrary, param2:String, param3:IStructureData)
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_13,onDataComplete);
      }
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         var_1709.append(var_1389);
         dispatchEvent(new Event(AvatarStructureDownload.const_965));
      }
   }
}
