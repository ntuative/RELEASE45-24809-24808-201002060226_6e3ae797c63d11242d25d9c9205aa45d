package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_654.width,var_654.height,true,0);
            _loc1_.bitmap.copyPixels(var_654,var_654.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1174.width,var_1174.height,true,0);
            _loc4_ = var_1174.clone();
            _loc4_.colorTransform(_loc4_.rect,var_837.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_973.width,var_973.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_973,var_973.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1489,var_1489.rect,new Point(0,0),null,null,true);
            }
         }
      }
