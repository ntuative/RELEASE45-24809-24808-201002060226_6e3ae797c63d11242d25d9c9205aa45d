package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_263:int = 100;
      ...
      {
         return Math.ceil(this.var_216.length / const_263);
      }
      ...
      {
         if(this.var_819 >= this.getPageCount())
         {
            this.var_819 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_819 + 1) * const_263,this.var_216.length);
      }
