package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1848:IAvatarRenderManager;
      ...
      private var var_806:FriendRequests;
      ...
      private var var_354:FriendListTabs;
      
      private var var_1915:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1451:OpenedToWebPopup;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1451 == null)
         {
            var_1451 = new OpenedToWebPopup(this);
         }
         var_1451.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_806.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_806.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_354.findTab(FriendListTab.const_78).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_145,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_806.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_114 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_806 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_306.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_306.addCategory(new FriendCategory(FriendCategory.const_948,getText("friendlist.friends")));
         var_306.addCategory(new FriendCategory(FriendCategory.const_457,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_306.addFriend(new Friend(_loc4_));
         }
         var_354 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_187.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_67);
      ...
      {
         var _loc2_:IAvatarImage = var_1848.createAvatarImage(param1,AvatarScaleType.const_85);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1848 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_806.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_354.findTab(FriendListTab.const_78);
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_354.findSelectedTab();
            if(_loc1_ == null)
            {
