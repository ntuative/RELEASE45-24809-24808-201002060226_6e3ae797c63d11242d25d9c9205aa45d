package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1394:String = "noconvinfo";
      ...
      private var var_1090:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1090 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_738 = IWindowContainer(var_11.content.findChildByName("main_content"));
         var_256 = IWindowContainer(var_11.content.findChildByName("footer"));
         var_1090.prepare(var_738);
         var_11.procedure = onWindow;
         var_11.content.setParamFlag(HabboWindowParam.const_823,false);
         var_11.content.setParamFlag(HabboWindowParam.const_1292,true);
         var_11.header.setParamFlag(HabboWindowParam.const_675,false);
         var_11.header.setParamFlag(HabboWindowParam.const_865,true);
         var_11.content.setParamFlag(HabboWindowParam.const_675,false);
         var_11.content.setParamFlag(HabboWindowParam.const_865,true);
         var_11.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1089 = ITextWindow(var_11.findChildByName("info_text"));
         var_1089.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_256.y = Util.getLowestPoint(var_11.content);
         ...
         var_11.scaler.setParamFlag(HabboWindowParam.const_939,this._friendList.tabs.findSelectedTab() != null);
         var_11.scaler.setParamFlag(HabboWindowParam.const_675,false);
         var_11.scaler.setParamFlag(HabboWindowParam.const_823,false);
         var_11.scaler.x = 0 - var_11.scaler.width;
         var_11.scaler.y = 0 - var_11.scaler.height;
         var_1370 = var_11.height;
         var_1371 = var_11.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1370 == -1 ? 0 : int(0 - var_1370);
         var _loc4_:int = var_1371 == -1 ? 0 : int(0 - var_1371);
