         ...
         if(object != null)
         {
            ...
            if(object.getType() == "pet")
            {
               ...
               if(param1 is RoomObjectAvatarFigureUpdateMessage)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1367,_loc4_.race);
               }
               ...
               if(param1 is RoomObjectAvatarSleepUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_382,Number(_loc7_.isSleeping));
               }
               if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
               {
                  _loc8_ = param1 as RoomObjectAvatarPetGestureUpdateMessage;
                  _loc2_.setString(RoomObjectVariableEnum.const_343,_loc8_.gesture);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_365,new Date().valueOf());
               }
               ...
               if(param1 is RoomObjectAvatarExperienceUpdateMessage)
               {
                  ...
                  _loc2_.setNumber(RoomObjectVariableEnum.const_851,Number(getTimer()));
                  _loc2_.setNumber(RoomObjectVariableEnum.const_929,Number(_loc12_.gainedExperience));
               }
            }
         }
      }
