package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1388:int = 0;
      
      private var var_560:String;
      
      private var var_597:int = 0;
      
      private const const_1598:int = 1;
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_538);
         ...
         var _loc21_:Boolean = _isAnimating || var_428 > 0;
         if(_loc20_ || _loc21_)
         {
            --var_428;
            _loc23_ = getTimer();
            ...
            if(_loc6_ == null)
            {
               _loc6_ = var_741.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_298);
            if(isNaN(_loc25_) || _loc4_.getString(RoomObjectVariableEnum.const_255) == "float")
            {
               _loc25_ = _loc24_;
            }
            else
            ...
            _loc26_ = _loc4_.getString(RoomObjectVariableEnum.const_255);
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_661);
            _loc6_.appendAction(AvatarAction.const_555,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_343);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_33)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_365);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_288,AvatarAction.const_1230[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_906);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_812,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_798);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_902);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_984,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_554);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_668);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_780,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_980);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_909,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_362);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_382) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_694);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_408);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_895);
            if(_loc36_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_659,_loc36_);
            }
            ...
            _loc43_ = getSprite(const_1597);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_914))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_741.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_740.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_740)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
