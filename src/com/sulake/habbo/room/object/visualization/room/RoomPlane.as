package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_166:int = 3;
      ...
      private var var_639:IPlaneRasterizer = null;
      ...
      private var var_1414:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         var_771.assign(param1);
         var_65 = new Vector3d();
         var_65.assign(param2);
         var_239 = new Vector3d();
         var_239.assign(param3);
         var_240 = new Vector3d();
         var_240.assign(param4);
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(var_770)
         {
            _loc4_ = null;
            _loc5_ = 0;
            while(_loc5_ < var_180.length)
            {
               _loc4_ = var_180[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_214 || _type == const_166))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_770 || false && false && !var_141 || var_584 == null)
         {
            return;
         }
         ...
         if(var_141)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_441);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_180.length)
            {
               _loc3_ = var_180[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = 0 - 0 * _loc3_.leftSideLoc / 0;
                  _loc11_ = 0 - 0 * _loc3_.rightSideLoc / 0;
                  _loc12_ = _loc3_.type;
                  var_584.updateMask(var_49,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_640.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_238.length)
            {
               _loc4_ = var_238[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  ...
                  var_961.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_141 = false;
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         if(var_639 != null)
         {
            return var_639.getTextureIdentifier(param1,normal);
         }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_214 || _type == const_166)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            ...
            {
               _loc4_ = var_180[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < var_640.length)
                  {
                     _loc7_ = var_640[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1147.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1147[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         updateMaskChangeStatus();
         if(_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || var_141)
         {
            return true;
         }
         return false;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(var_770)
         {
            ...
            while(_loc6_ < var_238.length)
            {
               _loc5_ = var_238[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_639 != null)
            {
               _loc3_ = var_639.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1414,var_1818,var_1815,var_1814,var_1816,param2);
               if(_loc3_ != null)
               {
