package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      {
         var_485 = true;
         var _loc3_:int = var_338.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_338.push(param1);
            var_483.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1026 = param1;
         var _loc3_:LayoutRasterizerData = var_56.getValue(var_694);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1284 = RoomObjectVariableEnum.const_799;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1284 = RoomObjectVariableEnum.const_890;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1026 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_1026 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_1026 + _adBgIndex);
            _loc5_ = param1.getSprite(var_1026 + _adImgIndex);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_360;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2135);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_694)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1027 = var_56.getValue(var_694);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_56.getValue(var_694);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_338.indexOf(_loc10_) >= 0 && var_485)
            {
               param1 = var_338.indexOf(_loc10_);
               if(true)
               {
