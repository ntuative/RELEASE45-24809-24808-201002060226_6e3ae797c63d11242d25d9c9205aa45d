package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1300:int = 13421772;
      
      private static const const_1036:int = 16777215;
      
      public static const const_1134:int = 10066329;
      ...
      private var var_1307:String = null;
      
      private var var_1777:int = 255;
      ...
      private var var_942:uint = 16777215;
      ...
      private var var_527:Rectangle = null;
      ...
      private const const_1608:int = 250;
      
      private var var_69:RoomPlaneParser = null;
      ...
      private function getLandscapeHeight() : Number
      {
         ...
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_69.planeCount)
         {
            _loc3_ = var_69.getPlaneType(_loc2_);
            if(_loc3_ == RoomPlaneData.const_225)
            {
               _loc4_ = var_69.getPlaneRightSide(_loc2_);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_919);
         if(!var_69.initializeFromXML(new XML(_loc2_)))
         {
            return;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_800);
         var _loc7_:int = 0;
         while(_loc7_ < var_69.planeCount)
         {
            _loc8_ = var_69.getPlaneLocation(_loc7_);
            _loc9_ = var_69.getPlaneLeftSide(_loc7_);
            _loc10_ = var_69.getPlaneRightSide(_loc7_);
            _loc11_ = var_69.getPlaneSecondaryNormals(_loc7_);
            _loc12_ = var_69.getPlaneType(_loc7_);
            _loc13_ = null;
            ...
            else if(_loc12_ == RoomPlaneData.const_119)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_225)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_166,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
            ...
            if(_loc13_ != null)
            {
               ...
               _loc15_ = 0;
               while(_loc15_ < var_69.getPlaneMaskCount(_loc7_))
               {
                  _loc16_ = var_69.getPlaneMaskLeftSideLoc(_loc7_,_loc15_);
                  _loc17_ = var_69.getPlaneMaskRightSideLoc(_loc7_,_loc15_);
                  _loc18_ = var_69.getPlaneMaskLeftSideLength(_loc7_,_loc15_);
                  _loc19_ = var_69.getPlaneMaskRightSideLength(_loc7_,_loc15_);
      ...
      override public function dispose() : void
      {
         ...
         if(var_98 != null)
         {
            ...
            {
               _loc2_ = var_98[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_527 == null)
         {
            var_527 = super.boundingRectangle;
         }
         return new Rectangle(var_527.x,var_527.y,var_527.width,var_527.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_364.maskCount)
         {
            _loc6_ = var_364.getMaskType(_loc5_);
            _loc7_ = var_364.getMaskLocation(_loc5_);
            _loc8_ = var_364.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_98.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_214 || _loc3_.type == RoomPlane.const_166 && _loc8_ == RoomPlaneBitmapMaskData.const_202)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1407;
                        if(var_69.getPlaneType(_loc9_) == RoomPlaneData.const_126)
                        {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_69.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_225)
            {
               _loc4_ = var_69.getPlaneLeftSide(_loc2_);
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1164)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_968 || _loc9_.y != var_1775 || _loc9_.z != var_1776 || param1.scale != var_1771))
            {
               var_968 = _loc9_.x;
               var_1775 = _loc9_.y;
               var_1776 = _loc9_.z;
         ...
         if(var_149 != _loc6_.getUpdateID())
         {
            ...
            _loc11_ = uint(_loc6_.getNumber(RoomObjectVariableEnum.const_496));
            if(_loc11_ != var_942)
            {
               var_942 = _loc11_;
               var_1770 = var_942 & 255;
               var_1773 = var_942 >> 8 & 255;
               var_1777 = var_942 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1778 + const_1608 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1778 = _loc7_;
         if(var_149 != _loc6_.getUpdateID())
         {
            ...
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_611);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_529);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_1772 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_893));
            var_149 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_365.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_365[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_166)
            {
               if(var_1772)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_1770 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_1773 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_1777 / 255);
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_98.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_166 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
