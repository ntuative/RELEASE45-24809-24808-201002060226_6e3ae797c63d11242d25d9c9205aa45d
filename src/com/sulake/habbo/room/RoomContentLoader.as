package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_748:String = "tile_cursor";
      
      private static const const_261:String = "RCL_PUBLICROOM_";
      ...
      private static const const_1071:String = const_328;
      ...
      public static const const_596:String = "RCL_LOADER_READY";
      ...
      private var var_1004:IEventDispatcher = null;
      
      private var var_1236:Map = null;
      ...
      private var var_162:PublicRoomData = null;
      
      public function RoomContentLoader()
      {
         var_460 = [];
         _wallItems = [];
         var_1998 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1999 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_391 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_318,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_109 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_393 != null)
         {
            _loc2_ = var_393.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_261 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(var_162 != null && var_162.hasWorldType(const_261 + param1))
         {
            return var_162.type;
         }
         return param1;
                  ...
                  for each(_loc8_ in _loc7_)
                  {
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           {
                              var_459.add(_loc10_,_loc11_);
                              if(var_460.indexOf(_loc14_) < 0)
                              {
                                 var_460.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_391 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_391.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_329 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_329.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_391.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_557.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_391.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_328,const_476,ROOM_CONTENT,const_748,const_750];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_14 || _loc2_ == RoomObjectCategoryEnum.const_12)
         {
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1998.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_141 && _loc5_ != RoomObjectLogicEnum.const_109)
         {
            _loc6_ = "@shadow";
      ...
      public function getPlaceHolderType(param1:String) : String
      {
         ...
         if(var_162 != null && (var_162.type == param1 || var_162.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1071;
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_392 != null)
         {
            _loc2_ = var_392.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1285);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1999.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1236.add(_loc5_,_loc8_);
               var_162 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_318,_loc5_);
         }
         else
         {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_460.indexOf(param1) >= 0)
         {
            return RoomObjectCategoryEnum.const_14;
         }
         if(_wallItems.indexOf(param1) >= 0)
         {
         ...
         if(var_162 != null && (var_162.type == param1 || var_162.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_45;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_45;
      ...
      private function continueInitilization() : void
      {
         if(var_1997)
         {
            ...
            if(var_1004 != null)
            {
               var_1004.dispatchEvent(new Event(const_596));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_162 != null)
         {
            return var_162.getWorldHeightScale(const_261 + param1);
         }
         return 1;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               if(_loc3_ == RoomObjectCategoryEnum.const_14 || _loc3_ == RoomObjectCategoryEnum.const_12)
               {
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            _loc5_.addEventListener(AssetLoaderEvent.const_13,furniDataLoadedHandler);
            _loc5_.addEventListener(AssetLoaderEvent.const_27,furniDataLoadedHandler);
            var_1004 = param1;
            var_2000 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1994 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1996 = param2.getKey("public.room.dynamic.download.url","");
            var_1995 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_30 = const_749;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_329.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_392 != null)
         {
            var_392.remove(param1);
            var_392.add(param1,param2);
         }
         if(var_393 != null)
         {
            var_393.remove(param2);
            var_393.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_141 && _loc5_ != RoomObjectVisualizationEnum.const_109)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_261 + param1) == RoomObjectCategoryEnum.const_45)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1236.getValue(param1) != null)
         {
            var_162 = var_1236.getValue(param1) as PublicRoomData;
         }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_162 != null)
         {
            return var_162.getWorldScale(const_261 + param1);
         }
         return 32;
      }
