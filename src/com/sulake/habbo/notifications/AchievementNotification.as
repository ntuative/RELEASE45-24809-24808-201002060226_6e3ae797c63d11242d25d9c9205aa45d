package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1589 = param2;
         var_513 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_93,onBadgeImageReady);
         ...
         var_176 = param5.getKey("notifications.text.achievement");
         registerBadgeParameters("notifications.text.achievement_facebook");
         var_2044 = param5.getKey("notifications.text.achievement_facebook");
         setText("achievement_info",var_176);
      ...
      public function dispose() : void
      {
         if(var_513 != null)
         {
            var_513.events.removeEventListener(BadgeImageReadyEvent.const_93,onBadgeImageReady);
            var_513 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_680,var_2044);
               }
               dispose();
               break;
      ...
      private function registerBadgeParameters(param1:String) : void
      {
         ...
         _localizations.registerParameter(param1,"level",var_1589.toString());
         _localizations.registerParameter(param1,"name",var_513.userName);
         _localizations.registerParameter(param1,"realname",var_513.realName);
      }
   }
}
