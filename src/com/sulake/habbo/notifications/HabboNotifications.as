package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1034:String = "pixelbalance";
      
      private static const const_1030:String = "credits";
      
      private static const const_1028:String = "inventory";
      
      private static const const_1032:String = "friendlist";
      
      private static const const_1033:String = "selectfurni";
      
      private static const const_1031:String = "selectbadge";
      ...
      private var var_1125:IHabboToolbar;
      ...
      private var var_177:HabboAlertDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_761);
         }
         var _loc6_:Map = var_761["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         var_625 = new ClubGiftNotification(_loc2_.numGifts,_assets,_windowManager,var_74);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_177 == null)
         {
            return;
         }
         var_177.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_177.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_177.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1245);
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         addItem(_loc2_,NotificationType.const_1278);
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1124.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_33);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_807,_loc5_);
         }
      }
      
      public function onAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_147 || param2.type == WindowEvent.const_548)
         {
            param1.dispose();
         }
      }
      ...
      {
         var _loc1_:Array = var_938.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1124.createPetImage(_loc2_.figure,AvatarScaleType.const_33);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_513);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc16_ = var_513.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_57)
               {
                  _loc16_ = var_513.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_513.getProductData(_loc4_.localizationId);
               switch(_loc15_.productType)
               {
                  case CatalogPageMessageProductData.const_56:
                     ...
                     break;
                  case CatalogPageMessageProductData.const_57:
                     ...
                     break;
                  case CatalogPageMessageProductData.const_184:
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_949,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1124.createAvatarImage(param2,AvatarScaleType.const_33);
         if(_loc7_ != null)
         {
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_177 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      {
         var_1125 = IHabboToolbar(param2);
         var_1125.events.addEventListener(HabboToolbarEvent.const_63,onHabboToolbarEvent);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_177.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_513.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_794);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_794);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_177.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            ...
            if(param2 == 3002)
            {
               return FurniCategory.const_274;
            }
            if(param2 == 4057)
            {
               return FurniCategory.const_270;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_63)
         {
            ...
            var_363 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_761["styles"],var_761["view"],var_1125);
            ...
            var_513.events.addEventListener(BadgeImageReadyEvent.const_93,onBadgeImage);
            var_1125.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
