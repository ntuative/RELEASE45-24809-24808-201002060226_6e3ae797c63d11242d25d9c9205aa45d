package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_950:Array = new Array();
      ...
      public static const const_1281:String = "AssetLibraryUnloaded";
      
      public static const const_363:String = "AssetLibraryLoaded";
      
      public static const const_1233:String = "AssetLibraryLoadError";
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_436 = _loc2_.manifest.copy();
         var_315 = _loc2_.resource;
         if(var_437)
         {
            AssetLibrary.fetchLibraryContents(this,var_436,var_315);
         }
         var_278 = true;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_13,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_27,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_956,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_920,assetLoadEventHandler);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_950.splice(var_950.indexOf(this),1);
            --var_530;
            var_369 = null;
            var_630 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_314.length ? getAssetByName(var_314[param1]) : null;
      }
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1233));
      }
      ...
      {
         var _loc2_:Class = var_630[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_13 == null)
            {
               var_13 = new LibraryLoader(var_1337);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_436.child("library");
         if(_loc2_ == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_314.splice(var_314.indexOf(_loc2_),1);
