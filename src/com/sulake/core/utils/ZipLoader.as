package com.sulake.core.utils
{
   ...
   public class ZipLoader extends LibraryLoader
   {
      ...
      private function onLoaderComplete(param1:Event) : void
      {
         ...
         var_1078.push(var_13.contentLoaderInfo.applicationDomain.getDefinition(_loc3_));
         ++var_730;
         if(var_1078.length == var_1638)
         {
         ...
         {
            var_13.loadBytes(var_355.getFileAt(var_730).content);
         }
      }
      ...
      override public function load(param1:URLRequest, param2:LoaderContext = null, param3:int = 1) : void
      {
         ...
         var_355 = new FZip();
         var_355.addEventListener(Event.COMPLETE,onComplete);
         var_355.addEventListener(IOErrorEvent.IO_ERROR,onIOError);
         var_355.addEventListener(ProgressEvent.PROGRESS,onProgress);
         var_355.load(var_301);
      }
