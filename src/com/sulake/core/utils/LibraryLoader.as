package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1380:uint = 2;
      
      protected static const const_1379:uint = 1;
      
      protected static const const_1377:int = 5;
      
      protected static const const_1070:uint = 7;
      
      protected static const const_1378:uint = 4;
      
      protected static const const_1376:uint = 3;
       
      
      protected var var_892:int;
      
      protected var var_2250:String = "";
      
      protected var var_349:int;
      
      protected var var_436:XML;
      ...
      protected function prepareLibrary() : void
      {
         ...
         if(var_315 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_301.url + "!");
            return;
         }
         try
         {
         ...
         var_436 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_416 == LibraryLoader.const_1376)
         {
            if(analyzeLibrary())
            {
               var_416 |= 0;
         ...
         if(var_416 == LibraryLoader.const_1070)
         {
            var_1335 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_892 > 0)
            {
               var_13.close();
               var_13.unload();
               addRequestCounterToUrlRequest(var_301,const_1377 - var_892);
               var_13.load(var_301,_context);
               --var_892;
               return true;
            }
