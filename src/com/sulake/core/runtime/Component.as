package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_997:uint = 4;
      ...
      protected var var_170:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         super();
         var_1065 = param2;
         var_170 = new InterfaceStructList();
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = var_170.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(var_1065 & const_997)
         {
            if(_loc3_ == 0)
            {
               if(var_170.getTotalReferenceCount() == 0)
               {
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         while(_loc8_ < _loc7_)
         {
            _loc6_ = var_170.getStructByIndex(_loc8_);
