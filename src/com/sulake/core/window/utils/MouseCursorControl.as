package com.sulake.core.window.utils
{
   ...
   public class MouseCursorControl extends Sprite implements IMouseCursor, IDisposable
   {
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            var_182.removeEventListener(Event.MOUSE_LEAVE,onStageMouseLeave);
            var_182.removeEventListener(MouseEvent.MOUSE_MOVE,onStageMouseMove);
            var_182.removeEventListener(MouseEvent.MOUSE_OVER,onStageMouseMove);
            var_182.removeEventListener(MouseEvent.MOUSE_OUT,onStageMouseMove);
            _disposed = true;
         }
      }
