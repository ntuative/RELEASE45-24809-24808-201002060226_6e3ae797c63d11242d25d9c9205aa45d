package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1495:String = "_INCLUDE";
      
      public static const const_769:String = "_EXCLUDE";
      
      public static const const_1480:String = "_TEMP";
      
      private static const const_1009:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1008:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      {
         param1 = param1.replace(const_1008,"");
         return param1.replace(const_1009,"");
      }
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_142)
                     {
                        window.x = rect.x;
                     }
                     if((params & 0) == WindowParam.const_138)
                     {
                        window.y = rect.y;
                     }
                  }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_769) == -1)
                  {
