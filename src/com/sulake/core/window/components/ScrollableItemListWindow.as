package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_725:IItemListWindow;
      
      private var var_308:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_48))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_308)
         {
            var_308 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_308)
            {
               var_308.addEventListener(WindowEvent.const_220,scrollBarEventProc);
               var_308.addEventListener(WindowEvent.const_201,scrollBarEventProc);
            }
         }
         return var_308;
      }
      ...
      override public function dispose() : void
      {
         if(var_308)
         {
            var_308.removeEventListener(WindowEvent.const_220,scrollBarEventProc);
            var_308.removeEventListener(WindowEvent.const_201,scrollBarEventProc);
            var_308 = null;
         }
         if(var_725)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_725)
         {
            var_725 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_725;
      }
