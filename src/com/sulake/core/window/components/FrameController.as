package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_758:String = "margin_top";
      
      private static const const_1084:String = "_HEADER";
      ...
      private static const const_756:String = "margin_left";
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:* = var_59 != null;
         var _loc3_:Rectangle = content.rectangle;
         _loc1_.push(new PropertyStruct(const_756,_loc3_.left,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(const_758,_loc3_.top,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(const_757,0 - _loc3_.right,PropertyStruct.const_42,_loc2_));
         _loc1_.push(new PropertyStruct(const_759,0 - _loc3_.bottom,PropertyStruct.const_42,_loc2_));
         return _loc1_;
      }
      ...
      public function get margins() : IMargins
      {
         ...
         if(!var_59)
         {
            ...
            var_59 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,marginsCallback);
         }
         return var_59;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_176);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_206);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_176,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_176,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1265 == null)
         {
            var_1265 = findChildByTag(const_1084) as IHeaderWindow;
            if(!var_1265)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_228,false);
         }
      ...
      {
         return content != null && var_1335 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_17 == null)
         {
            var_17 = findChildByTag(const_1083) as IWindowContainer;
            if(!var_17)
            {
