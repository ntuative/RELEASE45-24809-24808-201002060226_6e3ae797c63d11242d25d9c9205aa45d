package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_719:String = "";
      ...
      protected var var_885:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_415 = new Array();
         var_415[0] = MouseCursorType.const_309;
         var_415[1] = MouseCursorType.const_20;
         var_415[2] = MouseCursorType.const_309;
         var_415[3] = MouseCursorType.const_309;
         var_415[4] = MouseCursorType.const_20;
         var_415[5] = MouseCursorType.const_20;
         var_415[6] = MouseCursorType.const_309;
         if(var_304 == null)
         {
            var_304 = new Array();
            var_304[0] = WindowState.const_71;
            var_304[1] = WindowState.const_55;
            var_304[2] = WindowState.const_59;
            var_304[3] = WindowState.const_46;
            var_304[4] = WindowState.const_30;
            var_304[5] = WindowState.const_74;
            var_304[6] = WindowState.const_48;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1000,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_719));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_945,param1.toolTipDelay != const_1375));
         return param2;
      }
         ...
         for each(_loc3_ in param2)
         {
            switch(_loc3_.key)
            {
               ...
               case "mouse_cursor_disabled":
                  param1.setMouseCursorByState(WindowState.const_48,_loc3_.value as uint);
                  break;
            }
         }
      }
      ...
      {
         if(param1.toolTipCaption != const_719)
         {
      ...
      {
         var_886 = param1 == null ? const_719 : param1;
      }
