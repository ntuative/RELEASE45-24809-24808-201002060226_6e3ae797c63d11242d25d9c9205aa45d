package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_59:TextMargins;
      
      protected var var_502:String = "none";
      
      protected var var_590:Number;
      
      protected var var_348:Number;
      ...
      {
         var_59 = new TextMargins(0,0,0,0,setTextMargins);
         var_197 = false;
         var_590 = 0;
         var_348 = 0;
         if(_field == null)
      ...
      {
         param1.var_59.dispose();
         param1.var_59 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_590 * maxScrollH,var_348 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_713)
         {
            context.removeLocalizationListener(var_300,this);
         }
         if(var_59 != null)
         {
            var_59.dispose();
      ...
      {
         var_590 = param1;
         _field.scrollH = var_590 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_300 = param1;
         if(var_300.charAt(0) == "$" && var_300.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_300.slice(2,var_300.indexOf("}")),this);
            var_713 = true;
         }
         else if(_field != null)
         {
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_59.dispose();
            var_59 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_945,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_389,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_389,true));
         ...
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_42,true));
         ...
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_634,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.STRING,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_634,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_38,true));
         _loc1_.push(new PropertyStruct("margin_left",var_59.left,PropertyStruct.const_42,true));
         _loc1_.push(new PropertyStruct("margin_top",var_59.top,PropertyStruct.const_42,true));
         _loc1_.push(new PropertyStruct("margin_right",var_59.right,PropertyStruct.const_42,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_59.bottom,PropertyStruct.const_42,true));
         _loc1_.push(new PropertyStruct("auto_size",var_502,PropertyStruct.STRING,var_502 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_634,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_590 = var_590;
         _loc1_.var_348 = var_348;
         _loc1_.var_59 = var_59.clone(_loc1_.setTextMargins);
         _loc1_.var_502 = var_502;
         _loc1_.var_713 = var_713;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_502 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_502 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_502 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_502 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_5.x,var_5.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
