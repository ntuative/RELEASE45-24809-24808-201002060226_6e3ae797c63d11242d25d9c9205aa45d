package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      protected var var_893:ITabSelectorWindow;
      
      private var var_869:Boolean = false;
      
      protected var var_1560:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1560 == null)
         {
            var_1560 = findChildByTag(TabContextController.TAB_CONTEXT_CONTENT_TAG) as IWindowContainer;
         }
         return var_1560;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_893 == null)
         {
            var_893 = findChildByTag(TabContextController.TAB_CONTEXT_SELECTOR_TAG) as ITabSelectorWindow;
            if(var_893 != null)
            {
               var_893.procedure = selectorEventProc;
            }
         }
         return var_893;
      }
      ...
      {
         return !!var_869 ? selector.iterator : null;
      }
