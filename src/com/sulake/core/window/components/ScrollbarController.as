package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1110:String = "increment";
      
      private static const const_479:String = "slider_bar";
      
      private static const const_1109:String = "decrement";
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_479:
      ...
      {
         return track.findChildByName(ScrollbarController.const_479) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_874 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_874 != null)
         {
            _loc1_ = findParentByName(var_874) as IScrollableWindow;
            if(_loc1_ == null && var_6 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_6).findChildByName(var_874) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1110)
            {
               if(var_19)
               {
                  var_583 = true;
            ...
            else if(param2.name == ScrollbarController.const_1109)
            {
               if(var_19)
               {
                  var_583 = true;
            ...
            else if(param2.name == ScrollbarController.const_765)
            {
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_479).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_881)
         {
