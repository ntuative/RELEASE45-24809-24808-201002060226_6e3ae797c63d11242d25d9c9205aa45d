package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected static const const_1004:String = "resize_on_item_update";
      
      protected static const const_1003:String = "spacing";
      
      protected static const const_1384:Boolean = false;
      
      protected static const DEF_SPACING:int = 0;
      
      protected static const const_1001:String = "scale_to_fit_items";
      
      protected static const DEF_RESIZE_ON_ITEM_UPDATE:Boolean = false;
      
      protected static const const_1383:Boolean = true;
      
      protected static const const_1002:String = "auto_arrange_items";
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_82 = 0;
         var_60 = 0;
         _horizontal = param2 == WindowType.const_280;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11);
         var_150 = var_711 || !testParamFlag(WindowParam.const_15);
         _container = _context.create("_CONTAINER","",WindowType.const_286,WindowStyle.const_304,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_26,containerEventHandler);
         _container.addEventListener(WindowEvent.const_351,containerEventHandler);
         _container.addEventListener(WindowEvent.const_303,containerEventHandler);
         _container.addEventListener(WindowEvent.const_333,containerEventHandler);
      ...
      {
         return new Rectangle(var_506 * maxScrollH,var_505 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_351,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_303,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_333,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_506 = param1;
            _container.x = -var_506 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1003,_spacing,PropertyStruct.const_42,_spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1002,var_715,PropertyStruct.const_38,var_715 != const_1383));
         _loc1_.push(new PropertyStruct(const_1001,var_504,PropertyStruct.const_38,var_504 != const_1384));
         _loc1_.push(new PropertyStruct(const_1004,var_1066,PropertyStruct.const_38,var_1066 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_505 = param1;
            _container.y = -var_505 * maxScrollV;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_54);
         }
      }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_464,param1);
            }
            else
            {
