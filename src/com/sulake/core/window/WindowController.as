package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1501:Point = new Point();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_104,WindowParam.const_124);
         var _loc2_:* = !testParamFlag(WindowParam.const_86,WindowParam.const_125);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_5.clone();
            if(_loc1_)
            {
               ...
               else if(_loc5_ == WindowParam.const_142)
               {
            ...
            if(_loc2_)
            {
               ...
               else if(_loc5_ == WindowParam.const_138)
               {
      ...
      {
         var_711 = param1;
         var_588 = !!var_711 ? uint(var_588 | var_1326) : uint(var_588 & 16777215);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2084 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_885:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1234:
               _loc2_ = "null";
               _loc4_ = true;
               break;
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_868;
         update(this,_loc1_);
         return true;
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_14)
         {
            var_14 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_609,var_5);
            var_14.visible = var_307;
         }
         return var_14;
      }
      ...
      {
         var_360 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_5,WindowRedrawFlag.const_828);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1020 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_308,this,param1));
         return param1;
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_645))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_894;
                  if(testParamFlag(WindowParam.const_300))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_196))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_196))
                  {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_200:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_142,WindowParam.const_124))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_138,WindowParam.const_125))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_6 != null)
                     {
                        _loc8_ = uint(var_12);
                        var_12 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_464))
                        {
                           var_6.width += 0 - 0;
                        }
                        ...
                        var_12 = _loc8_;
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_250,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_444:
                  _context.invalidate(this,var_5.union(var_47),WindowRedrawFlag.const_347);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_987,this,null));
                     if(var_6 != null)
                     {
               ...
               case WindowNotifyEvent.const_291:
                  if(param1 == this)
                  {
                     ...
                     if(var_6 != null)
                     {
                        var_6.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_207,var_6,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_418:
                  _context.invalidate(this,var_5,WindowRedrawFlag.const_820);
                  break;
               case WindowNotifyEvent.const_398:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_424:
                  if(!(var_12 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_5,WindowRedrawFlag.const_347);
                     }
                  }
                  else if(var_12 & 0)
                  {
               ...
               case WindowNotifyEvent.const_207:
                  ...
                  break;
               case WindowNotifyEvent.const_460:
                  var_6.getRegionProperties(null,var_293);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_308:
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_504,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_557;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1020 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_383)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_340)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_782,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_605,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
         ...
         if(var_150 && var_714 > 0)
         {
            if(!testParamFlag(WindowParam.const_15))
            {
               if(param1.x <= var_5.width && param1.y <= var_5.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1501,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1501,param3,param1)) : false;
            }
         }
      ...
      public function unlock() : Boolean
      {
         ...
         setStateFlag(WindowState.const_46,false);
         _loc1_.type = WindowNotifyEvent.const_1262;
         update(this,_loc1_);
         return true;
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_6 != param1)
         {
            ...
            if(var_6 != null)
            {
               var_293 = var_6.rectangle.clone();
               var_47.x = var_5.x;
               var_47.y = var_5.y;
               var_47.width = var_5.width;
               var_47.height = var_5.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_367,this,var_6));
            }
            else
            {
               var_293.x = 0;
               ...
               var_293.width = 0;
               var_293.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_913,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_73,var_12,_context,var_5,null,var_591,properties,var_589.concat(),_id) as WindowController;
      ...
      {
         if(var_30 == WindowState.const_448)
         {
            return true;
         }
         var_30 = WindowState.const_448;
