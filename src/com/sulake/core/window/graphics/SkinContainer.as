package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1062:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1942 = new Dictionary();
         TypeCodeTable.fillTables(var_1459,var_1942);
         var_1210 = new Dictionary();
         var_1943 = new Dictionary();
         StateCodeTable.fillTables(var_1210,var_1943);
         var_452 = new Dictionary();
         var_452["skin"] = BitmapSkinRenderer;
         var_452["bitmap"] = BitmapDataRenderer;
         var_452["fill"] = FillSkinRenderer;
         var_452["text"] = TextSkinRenderer;
         var_452["shape"] = ShapeSkinRenderer;
         var_452["unknown"] = SkinRenderer;
         var_452["null"] = NullSkinRenderer;
         if(var_351 == null)
         {
            var_351 = new Array();
            var_351.push(WindowState.const_46);
            var_351.push(WindowState.const_48);
            var_351.push(WindowState.const_74);
      ...
      {
         var _loc3_:Array = var_553[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_553[param1] = new Array(SkinContainer.const_1062);
         }
         var_553[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_553[_loc1_]).dispose();
